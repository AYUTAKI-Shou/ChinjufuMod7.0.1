...
public class ChanokiNae_Item extends ItemBlockBace {

	public ChanokiNae_Item(String name) {
	...
	public EnumActionResult onItemUse(EntityPlayer playerIn, World worldIn, BlockPos pos, EnumHand hand, EnumFacing facing,
		...
		if (state.getBlock() instanceof BlockDirt && !stack.isEmpty() && canPlace) {
			...
			worldIn.setBlockState(pos, Crop_Blocks.CHANOKI.getDefaultState().withProperty(Chanoki.STAGE_0_4, Integer.valueOf(0)), 10);
	...
	public void addInformation(ItemStack stack, @Nullable World worldIn, List<String> tooltip, ITooltipFlag advanced) {
		...
		tooltip.add(I18n.format("tips.block_wood_chanoki_nae.name", meta));
	}
}
