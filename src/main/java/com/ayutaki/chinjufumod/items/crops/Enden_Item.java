...
public class Enden_Item extends ItemBlock {

	public Enden_Item(String name) {
	...
	public EnumActionResult onItemUse(EntityPlayer playerIn, World worldIn, BlockPos pos, EnumHand hand, EnumFacing facing,
		...
		if (!stack.isEmpty() && playerIn.canPlayerEdit(pos, facing, stack) && worldIn.mayPlace(Crop_Blocks.ENDEN, pos, false, facing, (Entity)null)) {
