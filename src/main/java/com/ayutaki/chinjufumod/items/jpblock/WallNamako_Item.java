...
public class WallNamako_Item extends ItemBlockBace {

	public WallNamako_Item(String name) {
	...
	public EnumActionResult onItemUse(EntityPlayer playerIn, World worldIn, BlockPos pos, EnumHand hand, EnumFacing facing,
		...
		if (!stack.isEmpty() && playerIn.canPlayerEdit(pos, facing, stack) && worldIn.mayPlace(JPBlock_Blocks.NAMAKO_WALL, pos, false, facing, (Entity)null)) {

			IBlockState state1 = JPBlock_Blocks.NAMAKO_WALL.getDefaultState().withProperty(Base_Wall.STAGE_0_15, Integer.valueOf(k));
