...
public class Shikkui_Item extends ItemBlockBace {

	public Shikkui_Item(String name) {
	...
	public EnumActionResult onItemUse(EntityPlayer playerIn, World worldIn, BlockPos pos, EnumHand hand, EnumFacing facing,
		...
		if (!stack.isEmpty() && playerIn.canPlayerEdit(pos, facing, stack) && worldIn.mayPlace(JPBlock_Blocks.SHIKKUI, pos, false, facing, (Entity)null)) {

			IBlockState state1 = JPBlock_Blocks.SHIKKUI.getDefaultState().withProperty(Kawara.STAGE_0_15, Integer.valueOf(k));
	...
	public void addInformation(ItemStack stack, @Nullable World worldIn, List<String> tooltip, ITooltipFlag advanced) {
		...
		tooltip.add(I18n.format("tips.block_plaster.name", meta));
	}
}
