...
public class Wadaiko_Item extends ItemBlockBace {

	public Wadaiko_Item(String name) {
	...
	public EnumActionResult onItemUse(EntityPlayer playerIn, World worldIn, BlockPos pos, EnumHand hand, EnumFacing facing,
		...
		if (!stack.isEmpty() && playerIn.canPlayerEdit(pos, facing, stack) && worldIn.mayPlace(JPDeco_Blocks.WADAIKO_BOT, pos, false, facing, (Entity)null)) {
