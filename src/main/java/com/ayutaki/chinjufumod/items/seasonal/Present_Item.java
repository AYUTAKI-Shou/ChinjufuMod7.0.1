...
public class Present_Item extends ItemBlockBace {

	public Present_Item(String name) {
	...
	public EnumActionResult onItemUse(EntityPlayer playerIn, World worldIn, BlockPos pos, EnumHand hand, EnumFacing facing,
		...
		if (!stack.isEmpty() && playerIn.canPlayerEdit(pos, facing, stack) && worldIn.mayPlace(Seasonal_Blocks.PRESENT, pos, false, facing, (Entity)null)) {

			IBlockState state1 = Seasonal_Blocks.PRESENT.getDefaultState().withProperty(BaseStage4_Face.H_FACING, direction)
