...
public class Andon2_Item extends ItemBlockBace {

	public Andon2_Item(String name) {
	...
	public EnumActionResult onItemUse(EntityPlayer playerIn, World worldIn, BlockPos pos, EnumHand hand, EnumFacing facing,
		...
		if (!stack.isEmpty() && playerIn.canPlayerEdit(pos, facing, stack) && worldIn.mayPlace(Lamp_Blocks.ANDON_2, pos, false, facing, (Entity)null)) {

			IBlockState state1 = Lamp_Blocks.ANDON_2.getDefaultState().withProperty(BaseStage4_Face.H_FACING, direction)
