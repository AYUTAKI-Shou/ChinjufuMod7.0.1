...
public class Andon1_Item extends ItemBlockBace {

	public Andon1_Item(String name) {
	...
	public EnumActionResult onItemUse(EntityPlayer playerIn, World worldIn, BlockPos pos, EnumHand hand, EnumFacing facing,
		...
		if (!stack.isEmpty() && playerIn.canPlayerEdit(pos, facing, stack) && worldIn.mayPlace(Lamp_Blocks.ANDON_1, pos, false, facing, (Entity)null)) {
			...
			IBlockState state1 = Lamp_Blocks.ANDON_1.getDefaultState().withProperty(BaseStage4_Face.H_FACING, direction)
