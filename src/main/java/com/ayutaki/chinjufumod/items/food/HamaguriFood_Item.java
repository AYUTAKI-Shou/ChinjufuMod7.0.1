...
public class HamaguriFood_Item extends ItemFood {

	public HamaguriFood_Item(String name, int amount, float saturation, boolean isWolfFood) {
	...
	public ItemStack onItemUseFinish(ItemStack stack, World worldIn, EntityLivingBase entityLiving) {
		...
		if (playerIn == null || !playerIn.capabilities.isCreativeMode) {
			if (stack.isEmpty()) { return new ItemStack(Items_Teatime.HAMAGURI_KARA); }
			else if (!playerIn.inventory.addItemStackToInventory(new ItemStack(Items_Teatime.HAMAGURI_KARA))) {
				playerIn.dropItem(new ItemStack(Items_Teatime.HAMAGURI_KARA), false); }
