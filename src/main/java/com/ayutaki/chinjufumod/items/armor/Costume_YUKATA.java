...
public class Costume_YUKATA extends Base_WearItem {
	...
	public Costume_YUKATA(ArmorMaterial material, EquipmentSlot slot, Item.Properties properties) {
	...
	public void appendHoverText(ItemStack stack, @Nullable Level worldIn, List<Component> tooltip, TooltipFlag tipFlag) {
		...
		tooltip.add(new TranslatableComponent("tips.item_ykt").withStyle(ChatFormatting.GRAY)); }
	}
}
