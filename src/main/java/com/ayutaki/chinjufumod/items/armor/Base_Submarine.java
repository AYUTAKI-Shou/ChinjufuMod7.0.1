...
public class Base_Submarine extends Base_ArmorItem {
	...
	public Base_Submarine(ArmorMaterial material, EquipmentSlot slot, Item.Properties properties) {
	...
	public void appendHoverText(ItemStack stack, @Nullable Level worldIn, List<Component> tooltip, TooltipFlag tipFlag) {
		tooltip.add(new TranslatableComponent("tips.item_sabumarine").withStyle(ChatFormatting.GRAY));
		tooltip.add(new TranslatableComponent("tips.item_sabumarine2").withStyle(ChatFormatting.GRAY));
	}
}
