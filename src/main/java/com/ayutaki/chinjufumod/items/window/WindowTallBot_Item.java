...
public class WindowTallBot_Item extends Item {

	public WindowTallBot_Item(String name) {
		super();
	...
	public EnumActionResult onItemUse(EntityPlayer playerIn, World worldIn, BlockPos pos, EnumHand hand, EnumFacing facing,
		...
		if (!stack.isEmpty() && playerIn.canPlayerEdit(pos, facing, stack) && worldIn.mayPlace(this.takeBlock(playerIn, hand), pos, false, facing, (Entity)null)) {
			...
			worldIn.setBlockState(pos, this.takeBlock(playerIn, hand).getDefaultState()
					.withProperty(WindowTall_Bottom.H_FACING, direction).withProperty(WindowTall_Bottom.STAGE_1_3, Integer.valueOf(1)), 2);
			worldIn.setBlockState(pos.up(), this.takeBlock2(playerIn, hand).getDefaultState()
					.withProperty(WindowTall_Top.H_FACING, direction).withProperty(WindowTall_Top.STAGE_1_3, Integer.valueOf(1)), 2);
	...
	private Block takeBlock(EntityPlayer playerIn, EnumHand hand) {
		...
		if (k == 8) { return Window_Blocks.WINDOWTALLBOT_ichoh; }
		return null;
	}
	...
	private Block takeBlock2(EntityPlayer playerIn, EnumHand hand) {
		...
		if (k == 8) { return Window_Blocks.WINDOWTALLTOP_ichoh; }
		return null;
	}
	...
	public void addInformation(ItemStack stack, @Nullable World worldIn, List<String> tooltip, ITooltipFlag advanced) {
		...
		tooltip.add(I18n.format("tips.block_windowb.name", meta));
	}
}
