...
public class GohanTake_Item extends ItemFood {

	public GohanTake_Item(String name, int amount, float saturation, boolean isWolfFood) {
	...
	protected void onFoodEaten(ItemStack stack, World worldIn, EntityPlayer playerIn) {
		...
		playerIn.addPotionEffect(new PotionEffect(new PotionEffect(MobEffects.HASTE, 200, 0)));
	}
	...
	public EnumActionResult onItemUse(EntityPlayer playerIn, World worldIn, BlockPos pos, EnumHand hand, EnumFacing facing,
		...
		if (!stack.isEmpty() && facing == EnumFacing.UP && playerIn.canPlayerEdit(pos, facing, stack) && worldIn
				.mayPlace(Dish_Blocks.GOHAN_TAKE, pos, false, facing, (Entity)null) && (playerIn.isSneaking() || playerIn.isRiding())) {

			/** Put the Block. **/
			IBlockState state1 = Dish_Blocks.GOHAN_TAKE.getDefaultState()
