...
public class DonGOK_Item extends ItemFood {

	public DonGOK_Item(String name, int amount, float saturation, boolean isWolfFood) {
	...
	private Block takeBlock() {
		...
		if (this == Items_Teatime.DONBURI_KAISEN) { return Dish_Blocks.DONBURI_KAISEN; }
		return null;
	}
	...
	public void addInformation(ItemStack stack, @Nullable World worldIn, List<String> tooltip, ITooltipFlag advanced) {
		...
		tooltip.add(I18n.format("tips.block_food_dongyu_1.name", meta));
	}
}
