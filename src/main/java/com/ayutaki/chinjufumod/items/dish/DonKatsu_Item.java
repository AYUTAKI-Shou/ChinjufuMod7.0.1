...
public class DonKatsu_Item extends ItemFood {

	public DonKatsu_Item(String name, int amount, float saturation, boolean isWolfFood) {
	...
	public EnumActionResult onItemUse(EntityPlayer playerIn, World worldIn, BlockPos pos, EnumHand hand, EnumFacing facing,
		...
		if (!stack.isEmpty() && facing == EnumFacing.UP && playerIn.canPlayerEdit(pos, facing, stack) && worldIn
			...
			/** Put the Block. **/
			IBlockState state1 = Dish_Blocks.DONBURI_KATSU.getDefaultState()
	...
	public void addInformation(ItemStack stack, @Nullable World worldIn, List<String> tooltip, ITooltipFlag advanced) {
		...
		tooltip.add(I18n.format("tips.block_food_donkatsu_1.name", meta));
	}
}
