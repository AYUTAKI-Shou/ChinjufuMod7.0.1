...
public class UdonNT_Item extends ItemFood {

	public UdonNT_Item(String name, int amount, float saturation, boolean isWolfFood) {
	...
	private Block takeBlock() {
		...
		if (this == Items_Teatime.UDON_TSUKIMI) { return Dish_Blocks.UDON_TSUKIMI; }
		return null;
	}
