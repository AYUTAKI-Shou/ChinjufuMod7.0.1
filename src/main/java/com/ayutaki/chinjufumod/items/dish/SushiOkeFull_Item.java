...
public class SushiOkeFull_Item extends ItemBlockBace {

	public SushiOkeFull_Item(String name) {
	...
	public EnumActionResult onItemUse(EntityPlayer playerIn, World worldIn, BlockPos pos, EnumHand hand, EnumFacing facing,
		...
		if (!stack.isEmpty() && playerIn.canPlayerEdit(pos, facing, stack) && worldIn.mayPlace(Dish_Blocks.SUSHIOKE_FULL_1, pos, false, facing, (Entity)null)) {

			/** Put the Block. **/
			IBlockState state1 = Dish_Blocks.SUSHIOKE_FULL_1.getDefaultState()
