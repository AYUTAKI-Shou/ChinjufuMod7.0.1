...
public class ChickenSmall_Item extends ItemFood {

	public ChickenSmall_Item(String name, int amount, float saturation, boolean isWolfFood) {
	...
	public EnumActionResult onItemUse(EntityPlayer playerIn, World worldIn, BlockPos pos, EnumHand hand, EnumFacing facing,
		...
		if (!block.isReplaceable(worldIn, pos)) { pos = pos.offset(facing); }
			...
			if (!stack.isEmpty() && facing == EnumFacing.UP && playerIn.canPlayerEdit(pos, facing, stack) && worldIn
				...
				/** Put the Block. **/
				IBlockState state1 = Dish_Blocks.CHICKEN_small.getDefaultState()
