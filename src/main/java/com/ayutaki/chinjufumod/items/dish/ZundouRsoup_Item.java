...
public class ZundouRsoup_Item extends ItemBlockBace {

	public ZundouRsoup_Item(String name) {
	...
	private Block takeBlock(EntityPlayer playerIn, EnumHand hand) {
		...
		if (k == 1) { return Dish_Blocks.ZUNDOU_RSOUP; }
		return null;
	}
	...
	public void addInformation(ItemStack stack, @Nullable World worldIn, List<String> tooltip, ITooltipFlag advanced) {
		...
		if (meta == 0) { tooltip.add(I18n.format("tips.block_frypan.name", meta)); }
	}
}
