...
public class Ramen_Item extends ItemFood {

	public Ramen_Item(String name, int amount, float saturation, boolean isWolfFood) {
	...
	private Block takeBlock(EntityPlayer playerIn, EnumHand hand) {
		...
		if (k == 2) { return Dish_Blocks.RAMEN_SHIO; }
		return null;
	}
