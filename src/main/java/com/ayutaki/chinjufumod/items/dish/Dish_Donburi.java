...
public class Dish_Donburi extends ItemNameBlockItem {
	...
	public void appendHoverText(ItemStack stack, @Nullable Level worldIn, List<Component> tooltip, TooltipFlag tipFlag) {
		...
		if (this == Items_Teatime.DONBURI_GYU.get()) {
			tooltip.add(new TranslatableComponent("tips.block_food_dongyu_1").withStyle(ChatFormatting.GRAY)); }
		if (this == Items_Teatime.DONBURI_KATSU.get()) {
			tooltip.add(new TranslatableComponent("tips.block_food_donkatsu_1").withStyle(ChatFormatting.GRAY)); }
		if (this == Items_Teatime.DONBURI_OYAKO.get()) {
			tooltip.add(new TranslatableComponent("tips.block_food_donoyako_1").withStyle(ChatFormatting.GRAY)); }
		if (this == Items_Teatime.DONBURI_KAISEN.get()) {
			tooltip.add(new TranslatableComponent("tips.block_food_donkaisen_1").withStyle(ChatFormatting.GRAY)); }
	}
}
