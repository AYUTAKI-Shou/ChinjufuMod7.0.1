...
public class GlassWine_Item extends ItemBlockBace {

	public GlassWine_Item(String name) {
	...
	public EnumActionResult onItemUse(EntityPlayer playerIn, World worldIn, BlockPos pos, EnumHand hand, EnumFacing facing,
		...
		if (!stack.isEmpty() && facing == EnumFacing.UP && playerIn.canPlayerEdit(pos, facing, stack) && worldIn
			...
			if (k == 1) {
				/** Put the Block. **/
				IBlockState state1 = Hakkou_Blocks.WINEGLASS.getDefaultState().withProperty(Glass_Wine.STAGE_1_15, Integer.valueOf(1));
				worldIn.setBlockState(pos, state1, 10); }
			if (k == 2) {
				IBlockState state1 = Hakkou_Blocks.WINEGLASS.getDefaultState().withProperty(Glass_Wine.STAGE_1_15, Integer.valueOf(4));
				worldIn.setBlockState(pos, state1, 10); }
			if (k == 3) {
				IBlockState state1 = Hakkou_Blocks.WINEGLASS.getDefaultState().withProperty(Glass_Wine.STAGE_1_15, Integer.valueOf(7));
				worldIn.setBlockState(pos, state1, 10); }
			if (k == 4) {
				IBlockState state1 = Hakkou_Blocks.WINEGLASS.getDefaultState().withProperty(Glass_Wine.STAGE_1_15, Integer.valueOf(10));
				worldIn.setBlockState(pos, state1, 10); }

			if (k == 5) {
				IBlockState state1 = Hakkou_Blocks.SAKEGLASS.getDefaultState().withProperty(Glass_Sake.STAGE_1_15, Integer.valueOf(10));
				worldIn.setBlockState(pos, state1, 10); }
			if (k == 6) {
				IBlockState state1 = Hakkou_Blocks.SAKEGLASS.getDefaultState().withProperty(Glass_Sake.STAGE_1_15, Integer.valueOf(13));
				worldIn.setBlockState(pos, state1, 10); }
