...
public class RensouHou127 extends Base_RensouHou {
	...
	public RensouHou127(Item.Properties properties) {
		super(properties);
	}
	...
	public void appendHoverText(ItemStack stack, @Nullable Level worldIn, List<Component> tooltip, TooltipFlag tipFlag) {
		tooltip.add(new TranslatableComponent("tips.item_rensouhou_small").withStyle(ChatFormatting.GRAY));
		tooltip.add(new TranslatableComponent("tips.item_rensouhou127").withStyle(ChatFormatting.DARK_GREEN));
	}
}
