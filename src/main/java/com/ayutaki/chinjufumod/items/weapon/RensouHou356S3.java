...
public class RensouHou356S3 extends Base_RensouHou {
	...
	public void appendHoverText(ItemStack stack, @Nullable Level worldIn, List<Component> tooltip, TooltipFlag tipFlag) {
		tooltip.add(Component.translatable("tips.item_rensouhou_large").withStyle(ChatFormatting.GRAY));
		tooltip.add(Component.translatable("tips.item_rensouhou356_s3").withStyle(ChatFormatting.DARK_GREEN));
	}
}
