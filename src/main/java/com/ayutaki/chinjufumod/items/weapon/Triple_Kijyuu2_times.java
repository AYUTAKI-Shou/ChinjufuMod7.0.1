...
public class Triple_Kijyuu2_times extends BowItem {

	public int SHOOTCOUNT = 0;
	
	public Triple_Kijyuu2_times(Item.Properties properties) {
	...
	public void appendHoverText(ItemStack stack, @Nullable Level worldIn, List<Component> tooltip, TooltipFlag tipFlag) {
		tooltip.add(new TranslatableComponent("tips.item_3rensou_kijyuu").withStyle(ChatFormatting.GRAY));
		tooltip.add(new TranslatableComponent("tips.item_3rensou_kijyuu2").withStyle(ChatFormatting.GRAY));
		tooltip.add(new TranslatableComponent("tips.item_3rensou_kijyuu3").withStyle(ChatFormatting.DARK_GREEN));
	}
}
