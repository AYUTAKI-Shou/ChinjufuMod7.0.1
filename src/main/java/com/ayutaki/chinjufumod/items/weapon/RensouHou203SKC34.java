...
public class RensouHou203SKC34 extends Base_RensouHou {
	...
	public void appendHoverText(ItemStack stack, @Nullable Level worldIn, List<Component> tooltip, TooltipFlag tipFlag) {
		tooltip.add(Component.translatable("tips.item_rensouhou_medium").withStyle(ChatFormatting.GRAY));
		tooltip.add(Component.translatable("tips.item_rensouhou203_skc34").withStyle(ChatFormatting.DARK_GREEN));
	}
}
