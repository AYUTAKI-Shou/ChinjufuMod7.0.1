...
public class KB_F4U extends Base_BowKansaiki {

	public KB_F4U(Properties properties) {
		super(properties);
	}
	...
	public void addInformation(ItemStack stack, @Nullable World worldIn, List<ITextComponent> tooltip, ITooltipFlag tipFlag) {
		...
		tooltip.add(new TranslationTextComponent("tips.item_kk_11f").applyTextStyle(TextFormatting.DARK_GREEN));
	}
}
