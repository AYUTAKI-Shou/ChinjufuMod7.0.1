...
public class KK_TBF extends Base_BowKansaiki {

	public KK_TBF(Item.Properties properties) {
		super(properties);
	}
	...
	public void appendHoverText(ItemStack stack, @Nullable World worldIn, List<ITextComponent> tooltip, ITooltipFlag tipFlag) {
		...
		tooltip.add(new TranslationTextComponent("tips.item_kk_11f").withStyle(TextFormatting.DARK_GREEN));
	}
}
