...
public class KK_Barracuda extends Base_BowKansaiki {

	public KK_Barracuda(Properties properties) {
		super(properties);
	}
	...
	public void addInformation(ItemStack stack, @Nullable World worldIn, List<ITextComponent> tooltip, ITooltipFlag tipFlag) {
		...
		tooltip.add(new TranslationTextComponent("tips.item_kk_7f").applyTextStyle(TextFormatting.DARK_GREEN));
	}
}
