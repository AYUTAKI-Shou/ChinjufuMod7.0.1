...
public class KB_TypeZero extends Base_BowKansaiki {

	public KB_TypeZero(Properties properties) {
		super(properties);
	}
	...
	public void addInformation(ItemStack stack, @Nullable World worldIn, List<ITextComponent> tooltip, ITooltipFlag tipFlag) {
		...
		tooltip.add(new TranslationTextComponent("tips.item_kk_10f").applyTextStyle(TextFormatting.DARK_GREEN));
	}
}
