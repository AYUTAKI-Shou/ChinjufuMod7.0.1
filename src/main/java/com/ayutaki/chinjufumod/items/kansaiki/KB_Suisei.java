...
public class KB_Suisei extends Base_BowKansaiki {

	public KB_Suisei(Properties properties) {
		super(properties);
	}
	...
	public void addInformation(ItemStack stack, @Nullable World worldIn, List<ITextComponent> tooltip, ITooltipFlag tipFlag) {
		...
		tooltip.add(new TranslationTextComponent("tips.item_kk_8f").applyTextStyle(TextFormatting.DARK_GREEN));
	}
}
