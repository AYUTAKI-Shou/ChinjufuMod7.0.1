...
public class KB_Ju87 extends Base_BowKansaiki {

	public KB_Ju87(Properties properties) {
		super(properties);
	}
	...
	public void addInformation(ItemStack stack, @Nullable World worldIn, List<ITextComponent> tooltip, ITooltipFlag tipFlag) {
		...
		tooltip.add(new TranslationTextComponent("tips.item_kk_9f").applyTextStyle(TextFormatting.DARK_GREEN));
	}
}
