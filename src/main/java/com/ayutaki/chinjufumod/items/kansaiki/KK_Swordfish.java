...
public class KK_Swordfish extends Base_BowKansaiki {

	public KK_Swordfish(Item.Properties properties) {
		super(properties);
	}
	...
	public void appendHoverText(ItemStack stack, @Nullable World worldIn, List<ITextComponent> tooltip, ITooltipFlag tipFlag) {
		...
		tooltip.add(new TranslationTextComponent("tips.item_kk_5f").withStyle(TextFormatting.DARK_GREEN));
	}
}
