...
public class LogChair_Item extends ItemBlockBace {

	public LogChair_Item(String name) {
	...
	public EnumActionResult onItemUse(EntityPlayer playerIn, World worldIn, BlockPos pos, EnumHand hand, EnumFacing facing,
		...
		if (!stack.isEmpty() && playerIn.canPlayerEdit(pos, facing, stack) && worldIn.mayPlace(Chinjufu_Blocks.LOGCHAIR, pos, false, facing, (Entity)null)) {

			IBlockState state1 = Chinjufu_Blocks.LOGCHAIR.getDefaultState().withProperty(LogChair.STAGE_0_8, Integer.valueOf(k));
