...
public class LowDesk_Item extends ItemBlockBace {

	public LowDesk_Item(String name) {
	...
	public EnumActionResult onItemUse(EntityPlayer playerIn, World worldIn, BlockPos pos, EnumHand hand, EnumFacing facing,
		...
		if (!stack.isEmpty() && playerIn.canPlayerEdit(pos, facing, stack) && worldIn.mayPlace(Unit_Blocks.LOWDESK, pos, false, facing, (Entity)null)) {

			IBlockState state1 = Unit_Blocks.LOWDESK.getDefaultState().withProperty(LowDesk.STAGE_0_8, Integer.valueOf(k));
