...
public class CafeTable_Item extends ItemBlockBace {

	public CafeTable_Item(String name) {
	...
	public EnumActionResult onItemUse(EntityPlayer playerIn, World worldIn, BlockPos pos, EnumHand hand, EnumFacing facing,
		...
		if (!stack.isEmpty() && playerIn.canPlayerEdit(pos, facing, stack) && worldIn.mayPlace(Unit_Blocks.CAFETABLE, pos, false, facing, (Entity)null)) {

			IBlockState state1 = Unit_Blocks.CAFETABLE.getDefaultState().withProperty(CafeTable.STAGE_0_8, Integer.valueOf(k));
