...
public class Unit_Blocks {
	...
	public static Block LETTERTRAY = register("block_lettertray_c", new TrayLetter(woodState()));
	public static Block FUDETRAY = register("block_fudetray_c", new TrayFude(woodState()));
