...
public class Items_Teatime {
	...
	public static Item PEPPER_RAW = register("item_crop_pepper", new AddInfo_Item(new Item.Properties().tab(ItemGroups_CM.TEATIME)));
	public static Item PEPPER_DRY = register("item_crop_pepperdry", new AddInfo_Item(new Item.Properties().tab(ItemGroups_CM.TEATIME)));
	public static Item CHILIPEPPER = register("item_crop_chilipepper", new AddInfo_Item(new Item.Properties().tab(ItemGroups_CM.TEATIME)));
	public static Item DUST_PEPPER = register("item_dust_blackpepper", new Item(new Item.Properties().tab(ItemGroups_CM.TEATIME)));
	public static Item DUST_CUMIN = register("item_dust_cumin", new Item(new Item.Properties().tab(ItemGroups_CM.TEATIME)));
	public static Item DUST_TURMERIC = register("item_dust_turmeric", new Item(new Item.Properties().tab(ItemGroups_CM.TEATIME)));
	public static Item DUST_CHILI = register("item_dust_chili", new Item(new Item.Properties().tab(ItemGroups_CM.TEATIME)));
	public static Item CURRY_ROUX = register("item_curry_roux", new Item(new Item.Properties().tab(ItemGroups_CM.TEATIME)));
	...
	public static Item FOOD_CHERRY = register("item_food_cherry", new FoodAnytime_addItem(new Item.Properties().tab(ItemGroups_CM.TEATIME)));
	...
	/** 6.4.1 **/ public static Item FOOD_GREENONION = register("item_food_greenonion", new Item(new Item.Properties().tab(ItemGroups_CM.TEATIME).food(FoodBuilders.GREENONION)));
	...
	public static Item SHOUYU_bot_1 = register("block_shouyu_bot", new HakkouItem_Tips(Hakkou_Blocks.SHOUYU_bot_1, new Item.Properties().tab(ItemGroups_CM.TEATIME).craftRemainder(Items_NoTab.SHOUYU_bot_2)));
	public static Item KOMEZU_bot_1 = register("block_komezu_bot", new HakkouItem_Tips(Hakkou_Blocks.KOMEZU_bot_1, new Item.Properties().tab(ItemGroups_CM.TEATIME).craftRemainder(Items_NoTab.KOMEZU_bot_2)));
	public static Item DASHI_bot_1 = register("block_dashi_bot", new HakkouItem_Tips(Hakkou_Blocks.DASHI_bot_1, new Item.Properties().tab(ItemGroups_CM.TEATIME).craftRemainder(Items_NoTab.DASHI_bot_2)));
	public static Item OSAUCE_bot_1 = register("block_osauce_bot", new HakkouItem_Tips(Dish_Blocks.OSAUCE_bot_1, new Item.Properties().tab(ItemGroups_CM.TEATIME).craftRemainder(Items_NoTab.OSAUCE_bot_2)));
	public static Item MAYO_bot_1 = register("block_mayo_bot", new HakkouItem_Tips(Dish_Blocks.MAYO_bot_1, new Item.Properties().tab(ItemGroups_CM.TEATIME).craftRemainder(Items_NoTab.MAYO_bot_2)));
	...
	public static Item BENTOUHAKO = register("item_bentouhako", new Item(new Item.Properties().tab(ItemGroups_CM.TEATIME)));
	...
	public static Item MUSHIGOME_TAKE = register("item_mushigome_take", new Item(new Item.Properties().tab(ItemGroups_CM.TEATIME).craftRemainder(Items.BOWL)));
	public static Item MUSHIGOME_KURI = register("item_mushigome_kuri", new Item(new Item.Properties().tab(ItemGroups_CM.TEATIME).craftRemainder(Items.BOWL)));
	...
	public static Item PIZZAC_nama = register("item_food_pizza_cn", new Item(new Item.Properties().tab(ItemGroups_CM.TEATIME)));
	public static Item PIZZAT_nama = register("item_food_pizza_tn", new Item(new Item.Properties().tab(ItemGroups_CM.TEATIME)));
	public static Item PIZZAS_nama = register("item_food_pizza_sn", new Item(new Item.Properties().tab(ItemGroups_CM.TEATIME)));
	...
	public static Item SHOUYU_donburi = register("item_food_shouyu_don", new AddInfo_Item(new Item.Properties().tab(ItemGroups_CM.TEATIME)));
	public static Item TSUYU_donburi = register("item_food_tsuyu_don", new AddInfo_Item(new Item.Properties().tab(ItemGroups_CM.TEATIME)));
	/** 6.4.1 **/
	...
	public static Item KANSUI = register("item_kansui", new AddInfo_Item(new Item.Properties().tab(ItemGroups_CM.TEATIME).craftRemainder(Items_Teatime.KEIRYO_CUP)));
	public static Item RAMEN_nama = register("item_food_ramen_n", new Item(new Item.Properties().tab(ItemGroups_CM.TEATIME)));
	public static Item SHOUYU_TARE = register("item_food_tare_shouyu", new AddInfo_Item(new Item.Properties().tab(ItemGroups_CM.TEATIME)));
	public static Item MISO_TARE = register("item_food_tare_miso", new AddInfo_Item(new Item.Properties().tab(ItemGroups_CM.TEATIME)));
	public static Item SHIO_TARE = register("item_food_tare_shio", new AddInfo_Item(new Item.Properties().tab(ItemGroups_CM.TEATIME)));
	public static Item SHOUYU_Rsoup = register("item_food_rsoup_shouyu", new AddInfo_Item(new Item.Properties().tab(ItemGroups_CM.TEATIME)));
	public static Item MISO_Rsoup = register("item_food_rsoup_miso", new AddInfo_Item(new Item.Properties().tab(ItemGroups_CM.TEATIME)));
	public static Item SHIO_Rsoup = register("item_food_rsoup_shio", new AddInfo_Item(new Item.Properties().tab(ItemGroups_CM.TEATIME)));
	public static Item SOBA_PLATE = register("item_food_sobaplate", new AddInfo_Item(new Item.Properties().tab(ItemGroups_CM.TEATIME)));
	...
	public static Item PC_PIZZAC = register("item_food_pizzac", new Item(new Item.Properties().tab(ItemGroups_CM.TEATIME).food(FoodBuilders.PC_PIZZAC)));
	public static Item PC_PIZZAT = register("item_food_pizzat", new Item(new Item.Properties().tab(ItemGroups_CM.TEATIME).food(FoodBuilders.PC_PIZZAT)));
	public static Item PC_PIZZAS = register("item_food_pizzas", new Item(new Item.Properties().tab(ItemGroups_CM.TEATIME).food(FoodBuilders.PC_PIZZAS)));
	...
	public static Item ONIGIRI_TAKE = register("item_food_onigiritakenoko", new Item(new Item.Properties().tab(ItemGroups_CM.TEATIME).food(FoodBuilders.ONIGIRI_TAKEKURI)));
	public static Item ONIGIRI_KURI = register("item_food_onigirikuri", new Item(new Item.Properties().tab(ItemGroups_CM.TEATIME).food(FoodBuilders.ONIGIRI_TAKEKURI)));
	...
	public static Item KUSHI_SAKANA_C = register("item_kushi_sakana_c", new FoodNeed_addItem(new Item.Properties().tab(ItemGroups_CM.TEATIME)));
	...
	public static Item MOCHI = register("item_mochi", new Item(new Item.Properties().tab(ItemGroups_CM.TEATIME)));
	public static Item MOCHI_NORI = register("item_food_mochinori", new AddInfo_Item(new Item.Properties().tab(ItemGroups_CM.TEATIME).food(FoodBuilders.MOCHI)));
	public static Item MOCHI_KINAKO = register("item_food_mochikinako", new AddInfo_Item(new Item.Properties().tab(ItemGroups_CM.TEATIME).food(FoodBuilders.MOCHI)));
	...
	public static Item KAIHORI = register("item_kaihori", new Kaihori_Item(new Item.Properties().durability(256)));
	public static Item HAMAGURI_COOK = register("item_food_hamaguri", new FoodNeed_addItem(new Item.Properties().tab(ItemGroups_CM.TEATIME)));
	public static Item HAMAGURI = register("block_hamaguri", new Teatime_noFuel(Crop_Blocks.HAMAGURI, new Item.Properties()));

	public static Item KINE_YOKO = register("item_kineyoko", new KineYoko_Item(new Item.Properties()));
