...
public class Items_Teatime {
	...
	/** 6.4.1 **/ public static final RegistryObject<Item> SEEDS_GREENONION = register("item_seeds_greenonion", () -> new Teatime_noFuel(Crop_Blocks.GREENONION.get(), new Item.Properties()));
	...
	public static final RegistryObject<Item> MIKAN = register("block_wood_mikan", () -> new Teatime_noFuel(Crop_Blocks.MIKAN.get(), new Item.Properties()));
	...
	public static final RegistryObject<Item> CHABA = register("item_chaba", () -> new Item(new Item.Properties().tab(ItemGroups_CM.TEATIME)));
	public static final RegistryObject<Item> CHABA_GREEN = register("item_chaba_green", () -> new Item(new Item.Properties().tab(ItemGroups_CM.TEATIME)));
	public static final RegistryObject<Item> CHABA_RED = register("item_chaba_red", () -> new Item(new Item.Properties().tab(ItemGroups_CM.TEATIME)));
	...
	public static final RegistryObject<Item> INEWARA = register("item_inewara", () -> new Item(new Item.Properties().tab(ItemGroups_CM.TEATIME)));
	public static final RegistryObject<Item> INE = register("item_ine", () -> new Item(new Item.Properties().tab(ItemGroups_CM.TEATIME).craftRemainder(Items_Teatime.INEWARA.get())));
	public static final RegistryObject<Item> INE_D = register("item_ine_dry", () -> new Item(new Item.Properties().tab(ItemGroups_CM.TEATIME).craftRemainder(Items_Teatime.INEWARA.get())));
	public static final RegistryObject<Item> KOME = register("item_kome", () -> new Item(new Item.Properties().tab(ItemGroups_CM.TEATIME)));

	public static final RegistryObject<Item> SAYA = register("item_saya", () -> new Item(new Item.Properties().tab(ItemGroups_CM.TEATIME)));
	public static final RegistryObject<Item> SOY = register("item_soy", () -> new Item(new Item.Properties().tab(ItemGroups_CM.TEATIME)));
	public static final RegistryObject<Item> PEPPER_RAW = register("item_crop_pepper", () -> new AddInfo_Item(new Item.Properties().tab(ItemGroups_CM.TEATIME)));
	public static final RegistryObject<Item> PEPPER_DRY = register("item_crop_pepperdry", () -> new AddInfo_Item(new Item.Properties().tab(ItemGroups_CM.TEATIME)));
	public static final RegistryObject<Item> CHILIPEPPER = register("item_crop_chilipepper", () -> new AddInfo_Item(new Item.Properties().tab(ItemGroups_CM.TEATIME)));
	public static final RegistryObject<Item> DUST_PEPPER = register("item_dust_blackpepper", () -> new Item(new Item.Properties().tab(ItemGroups_CM.TEATIME)));
	public static final RegistryObject<Item> DUST_CUMIN = register("item_dust_cumin", () -> new Item(new Item.Properties().tab(ItemGroups_CM.TEATIME)));
	public static final RegistryObject<Item> DUST_TURMERIC = register("item_dust_turmeric", () -> new Item(new Item.Properties().tab(ItemGroups_CM.TEATIME)));
	public static final RegistryObject<Item> DUST_CHILI = register("item_dust_chili", () -> new Item(new Item.Properties().tab(ItemGroups_CM.TEATIME)));
	public static final RegistryObject<Item> CURRY_ROUX = register("item_curry_roux", () -> new Item(new Item.Properties().tab(ItemGroups_CM.TEATIME)));

	public static final RegistryObject<Item> FOOD_CABBAGE = register("item_food_cabbage", () -> new Item(new Item.Properties().tab(ItemGroups_CM.TEATIME).food(FoodBuilders.CABBAGE)));
	public static final RegistryObject<Item> FOOD_HAKUSAI = register("item_food_hakusai", () -> new Item(new Item.Properties().tab(ItemGroups_CM.TEATIME).food(FoodBuilders.HAKUSAI)));
	public static final RegistryObject<Item> FOOD_CHERRY = register("item_food_cherry", () -> new FoodAnytime_addItem(new Item.Properties().tab(ItemGroups_CM.TEATIME)));
	public static final RegistryObject<Item> FOOD_MIKAN = register("item_food_mikan", () -> new Item(new Item.Properties().tab(ItemGroups_CM.TEATIME).food(FoodBuilders.MIKAN)));
	public static final RegistryObject<Item> FOOD_CORN = register("item_food_corn", () -> new Item(new Item.Properties().tab(ItemGroups_CM.TEATIME).food(FoodBuilders.CORN)));
	public static final RegistryObject<Item> FOOD_GRAPE = register("item_food_grape", () -> new Item(new Item.Properties().tab(ItemGroups_CM.TEATIME).food(FoodBuilders.GRAPE)));
	/** 6.4.1 **/ public static final RegistryObject<Item> FOOD_GREENONION = register("item_food_greenonion", () -> new Item(new Item.Properties().tab(ItemGroups_CM.TEATIME).food(FoodBuilders.GREENONION)));
	public static final RegistryObject<Item> FOOD_ONION = register("item_food_onion", () -> new Item(new Item.Properties().tab(ItemGroups_CM.TEATIME).food(FoodBuilders.ONION)));
	public static final RegistryObject<Item> FOOD_SPINACH = register("item_food_spinach", () -> new Item(new Item.Properties().tab(ItemGroups_CM.TEATIME).food(FoodBuilders.SPINACH)));
	public static final RegistryObject<Item> FOOD_TOMATO = register("item_food_tomato", () -> new Item(new Item.Properties().tab(ItemGroups_CM.TEATIME).food(FoodBuilders.TOMATO)));

	public static final RegistryObject<Item> FOOD_CORN_B = register("item_food_cornb", () -> new Item(new Item.Properties().tab(ItemGroups_CM.TEATIME).food(FoodBuilders.CORN_B)));
	...
	public static final RegistryObject<Item> BOX_H_FISH = register("block_boxh_fish", () -> new Teatime_Fuel100(Pantry_Blocks.BOX_H_FISH.get(), new Item.Properties()));
	...
	/** 6.4.1 **/ public static final RegistryObject<Item> BOX_H_GREENONION = register("block_boxh_greenonion", () -> new Teatime_Fuel100(Pantry_Blocks.BOX_H_GREENONION.get(), new Item.Properties()));
	...
	/* Barrel */
	public static final RegistryObject<Item> KOUBOBOT_full = register("block_bin_koubo_f", () -> new Teatime_noFuel(Hakkou_Blocks.KOUBOBOT_full.get(), new Item.Properties()));
	public static final RegistryObject<Item> NYUSANBOT_full = register("block_bin_nyusan_f", () -> new Teatime_noFuel(Hakkou_Blocks.NYUSANBOT_full.get(), new Item.Properties()));
	public static final RegistryObject<Item> KOUBO = register("item_koubo", () -> new AddInfo_Item(new Item.Properties().tab(ItemGroups_CM.TEATIME).craftRemainder(Items.GLASS_BOTTLE)));
	public static final RegistryObject<Item> NYUSAN = register("item_nyusan", () -> new AddInfo_Item(new Item.Properties().tab(ItemGroups_CM.TEATIME).craftRemainder(Items.GLASS_BOTTLE)));
	...
	public static final RegistryObject<Item> SHOUYU_bot_1 = register("block_shouyu_bot", () -> new HakkouItem_Tips(Hakkou_Blocks.SHOUYU_bot_1.get(), new Item.Properties().tab(ItemGroups_CM.TEATIME).craftRemainder(Items_NoTab.SHOUYU_bot_2.get())));
	public static final RegistryObject<Item> KOMEZU_bot_1 = register("block_komezu_bot", () -> new HakkouItem_Tips(Hakkou_Blocks.KOMEZU_bot_1.get(), new Item.Properties().tab(ItemGroups_CM.TEATIME).craftRemainder(Items_NoTab.KOMEZU_bot_2.get())));
	public static final RegistryObject<Item> DASHI_bot_1 = register("block_dashi_bot", () -> new HakkouItem_Tips(Hakkou_Blocks.DASHI_bot_1.get(), new Item.Properties().tab(ItemGroups_CM.TEATIME).craftRemainder(Items_NoTab.DASHI_bot_2.get())));
	public static final RegistryObject<Item> OSAUCE_bot_1 = register("block_osauce_bot", () -> new HakkouItem_Tips(Dish_Blocks.OSAUCE_bot_1.get(), new Item.Properties().tab(ItemGroups_CM.TEATIME).craftRemainder(Items_NoTab.OSAUCE_bot_2.get())));
	public static final RegistryObject<Item> MAYO_bot_1 = register("block_mayo_bot", () -> new HakkouItem_Tips(Dish_Blocks.MAYO_bot_1.get(), new Item.Properties().tab(ItemGroups_CM.TEATIME).craftRemainder(Items_NoTab.MAYO_bot_2.get())));

	public static final RegistryObject<Item> MATCH = register("item_match_cm", () -> new Match_Item(new Item.Properties()));

	public static final RegistryObject<Item> SARA = register("item_food_sara", () -> new Item(new Item.Properties().tab(ItemGroups_CM.TEATIME)));
	public static final RegistryObject<Item> YUNOMI = register("item_food_yunomi", () -> new AddInfo_Item(new Item.Properties().tab(ItemGroups_CM.TEATIME)));
	public static final RegistryObject<Item> TCUP_kara = register("item_food_teacup", () -> new Item(new Item.Properties().tab(ItemGroups_CM.TEATIME)));
	public static final RegistryObject<Item> CHAWAN = register("item_food_chawan", () -> new AddInfo_Item(new Item.Properties().tab(ItemGroups_CM.TEATIME)));
	public static final RegistryObject<Item> SHIKKI = register("item_food_shikki", () -> new AddInfo_Item(new Item.Properties().tab(ItemGroups_CM.TEATIME)));
	public static final RegistryObject<Item> TONSUI = register("item_food_tonsui", () -> new AddInfo_Item(new Item.Properties().tab(ItemGroups_CM.TEATIME)));
	public static final RegistryObject<Item> DONBURI = register("item_food_donburi", () -> new AddInfo_Item(new Item.Properties().tab(ItemGroups_CM.TEATIME)));
	public static final RegistryObject<Item> DRINKGLASS = register("item_food_driglass", () -> new Item(new Item.Properties().tab(ItemGroups_CM.TEATIME)));
	public static final RegistryObject<Item> SAKEBOTTLE = register("item_food_sakebot", () -> new Item(new Item.Properties().tab(ItemGroups_CM.TEATIME)));
	public static final RegistryObject<Item> BENTOUHAKO = register("item_bentouhako", () -> new Item(new Item.Properties().tab(ItemGroups_CM.TEATIME)));
	
	public static final RegistryObject<Item> CLAY_SARA = register("item_clay_sara", () -> new AddInfo_Item(new Item.Properties().tab(ItemGroups_CM.TEATIME)));
	public static final RegistryObject<Item> CLAY_YUNOMI = register("item_clay_yunomi", () -> new AddInfo_Item(new Item.Properties().tab(ItemGroups_CM.TEATIME)));
	public static final RegistryObject<Item> CLAY_KYUSU = register("item_clay_kyusu", () -> new AddInfo_Item(new Item.Properties().tab(ItemGroups_CM.TEATIME)));
	public static final RegistryObject<Item> CLAY_TCUP = register("item_clay_teacup", () -> new AddInfo_Item(new Item.Properties().tab(ItemGroups_CM.TEATIME)));
	public static final RegistryObject<Item> CLAY_TPOT = register("item_clay_teapot", () -> new AddInfo_Item(new Item.Properties().tab(ItemGroups_CM.TEATIME)));
	public static final RegistryObject<Item> CLAY_CHAWAN = register("item_clay_chawan", () -> new AddInfo_Item(new Item.Properties().tab(ItemGroups_CM.TEATIME)));
	public static final RegistryObject<Item> CLAY_NABE = register("item_clay_nabe", () -> new AddInfo_Item(new Item.Properties().tab(ItemGroups_CM.TEATIME)));
	public static final RegistryObject<Item> CLAY_TONSUI = register("item_clay_tonsui", () -> new AddInfo_Item(new Item.Properties().tab(ItemGroups_CM.TEATIME)));
	public static final RegistryObject<Item> CLAY_DONBURI = register("item_clay_donburi", () -> new AddInfo_Item(new Item.Properties().tab(ItemGroups_CM.TEATIME)));

	/* Salt */
	public static final RegistryObject<Item> SHIO = register("item_salt", () -> new Item(new Item.Properties().tab(ItemGroups_CM.TEATIME)));
	public static final RegistryObject<Item> NIGARI = register("item_nigari", () -> new AddInfo_Item(new Item.Properties().tab(ItemGroups_CM.TEATIME)));
	public static final RegistryObject<Item> RENNET = register("item_rennet", () -> new AddInfo_Item(new Item.Properties().tab(ItemGroups_CM.TEATIME)));

	public static final RegistryObject<Item> MUSHIGOME = register("item_mushigome", () -> new Item(new Item.Properties().tab(ItemGroups_CM.TEATIME).craftRemainder(Items.BOWL)));
	public static final RegistryObject<Item> MUSHIGOME_TAKE = register("item_mushigome_take", () -> new Item(new Item.Properties().tab(ItemGroups_CM.TEATIME).craftRemainder(Items.BOWL)));
	public static final RegistryObject<Item> MUSHIGOME_KURI = register("item_mushigome_kuri", () -> new Item(new Item.Properties().tab(ItemGroups_CM.TEATIME).craftRemainder(Items.BOWL)));
	public static final RegistryObject<Item> KOMEKOUJI = register("item_komekouji", () -> new AddInfo_Item(new Item.Properties().tab(ItemGroups_CM.TEATIME)));
	public static final RegistryObject<Item> SHUBO = register("item_shubo", () -> new AddInfo_Item(new Item.Properties().tab(ItemGroups_CM.TEATIME).craftRemainder(Items.BOWL)));
	public static final RegistryObject<Item> SAKEKASU = register("item_sakekasu", () -> new AddInfo_Item(new Item.Properties().tab(ItemGroups_CM.TEATIME).craftRemainder(Items.BOWL)));
	public static final RegistryObject<Item> MOROMI = register("item_moromi", () -> new AddInfo_Item(new Item.Properties().tab(ItemGroups_CM.TEATIME).craftRemainder(Items_Teatime.SAKEKASU.get())));

	public static final RegistryObject<Item> NIMAME = register("item_nimame", () -> new Item(new Item.Properties().tab(ItemGroups_CM.TEATIME).craftRemainder(Items.BOWL)));
	public static final RegistryObject<Item> MISO = register("item_miso", () -> new Item(new Item.Properties().tab(ItemGroups_CM.TEATIME)));

	public static final RegistryObject<Item> KOMUGI = register("item_flour", () -> new Item(new Item.Properties().tab(ItemGroups_CM.TEATIME)));
	public static final RegistryObject<Item> BUTTER = register("item_butter", () -> new Item(new Item.Properties().tab(ItemGroups_CM.TEATIME)));
	public static final RegistryObject<Item> KIJI_BUN = register("item_kiji_bun", () -> new AddInfo_Item(new Item.Properties().tab(ItemGroups_CM.TEATIME)));
	public static final RegistryObject<Item> KIJI_BURG = register("item_kiji_burg", () -> new AddInfo_Item(new Item.Properties().tab(ItemGroups_CM.TEATIME)));
	public static final RegistryObject<Item> KIJI_SCONE= register("item_kiji_scone", () -> new AddInfo_Item(new Item.Properties().tab(ItemGroups_CM.TEATIME)));
	public static final RegistryObject<Item> KIJI_SENBEI = register("item_kiji_senbei", () -> new AddInfo_Item(new Item.Properties().tab(ItemGroups_CM.TEATIME)));
	public static final RegistryObject<Item> KIJI_PIZA = register("item_kiji_pizza", () -> new Item(new Item.Properties().tab(ItemGroups_CM.TEATIME)));
	public static final RegistryObject<Item> PIZZA_nama = register("item_food_pizza_n", () -> new Item(new Item.Properties().tab(ItemGroups_CM.TEATIME)));
	public static final RegistryObject<Item> PIZZAC_nama = register("item_food_pizza_cn", () -> new Item(new Item.Properties().tab(ItemGroups_CM.TEATIME)));
	public static final RegistryObject<Item> PIZZAT_nama = register("item_food_pizza_tn", () -> new Item(new Item.Properties().tab(ItemGroups_CM.TEATIME)));
	public static final RegistryObject<Item> PIZZAS_nama = register("item_food_pizza_sn", () -> new Item(new Item.Properties().tab(ItemGroups_CM.TEATIME)));

	public static final RegistryObject<Item> PASTA_nama = register("item_food_pasta_n", () -> new Item(new Item.Properties().tab(ItemGroups_CM.TEATIME)));
	public static final RegistryObject<Item> PASTA_sara = register("item_food_pasta_s", () -> new Item(new Item.Properties().tab(ItemGroups_CM.TEATIME)));
	public static final RegistryObject<Item> UDON_nama = register("item_food_udon_n", () -> new Item(new Item.Properties().tab(ItemGroups_CM.TEATIME)));
	public static final RegistryObject<Item> SHOUYU_donburi = register("item_food_shouyu_don", () -> new AddInfo_Item(new Item.Properties().tab(ItemGroups_CM.TEATIME)));
	public static final RegistryObject<Item> TSUYU_donburi = register("item_food_tsuyu_don", () -> new AddInfo_Item(new Item.Properties().tab(ItemGroups_CM.TEATIME)));
	/** 6.4.1 **/
	...
	public static final RegistryObject<Item> KEIRYO_CUP_full = register("item_measurecup_full", () -> new AddInfo_Item(new Item.Properties().tab(ItemGroups_CM.TEATIME).craftRemainder(Items_Teatime.KEIRYO_CUP.get())));
	public static final RegistryObject<Item> KANSUI = register("item_kansui", () -> new AddInfo_Item(new Item.Properties().tab(ItemGroups_CM.TEATIME).craftRemainder(Items_Teatime.KEIRYO_CUP.get())));
	public static final RegistryObject<Item> RAMEN_nama = register("item_food_ramen_n", () -> new Item(new Item.Properties().tab(ItemGroups_CM.TEATIME)));
	public static final RegistryObject<Item> SHOUYU_TARE = register("item_food_tare_shouyu", () -> new AddInfo_Item(new Item.Properties().tab(ItemGroups_CM.TEATIME)));
	public static final RegistryObject<Item> MISO_TARE = register("item_food_tare_miso", () -> new AddInfo_Item(new Item.Properties().tab(ItemGroups_CM.TEATIME)));
	public static final RegistryObject<Item> SHIO_TARE = register("item_food_tare_shio", () -> new AddInfo_Item(new Item.Properties().tab(ItemGroups_CM.TEATIME)));
	public static final RegistryObject<Item> SHOUYU_Rsoup = register("item_food_rsoup_shouyu", () -> new AddInfo_Item(new Item.Properties().tab(ItemGroups_CM.TEATIME)));
	public static final RegistryObject<Item> MISO_Rsoup = register("item_food_rsoup_miso", () -> new AddInfo_Item(new Item.Properties().tab(ItemGroups_CM.TEATIME)));
	public static final RegistryObject<Item> SHIO_Rsoup = register("item_food_rsoup_shio", () -> new AddInfo_Item(new Item.Properties().tab(ItemGroups_CM.TEATIME)));
	public static final RegistryObject<Item> SOBA_PLATE = register("item_food_sobaplate", () -> new AddInfo_Item(new Item.Properties().tab(ItemGroups_CM.TEATIME)));
	...
	public static final RegistryObject<Item> FPKATSU_bake = register("block_food_frypan_b_katsu", () -> new Item(new Item.Properties().tab(ItemGroups_CM.TEATIME)));
	...
	public static final RegistryObject<Item> FPKINOKOAK = register("item_food_frypan_b_kinokoak", () -> new AddInfo_Item(new Item.Properties().craftRemainder(Items_Teatime.FRYPAN_kara.get()).tab(ItemGroups_CM.TEATIME)));
	...
	public static final RegistryObject<Item> FOOD_HAKUSAI2 = register("item_food_hakusai2", () -> new Item(new Item.Properties().tab(ItemGroups_CM.TEATIME).food(FoodBuilders.HAKUSAI2)));
	...
	public static final RegistryObject<Item> PC_PIZZA = register("item_food_pizza", () -> new Item(new Item.Properties().tab(ItemGroups_CM.TEATIME).food(FoodBuilders.PC_PIZZA)));
	public static final RegistryObject<Item> PC_PIZZAC = register("item_food_pizzac", () -> new Item(new Item.Properties().tab(ItemGroups_CM.TEATIME).food(FoodBuilders.PC_PIZZAC)));
	public static final RegistryObject<Item> PC_PIZZAT = register("item_food_pizzat", () -> new Item(new Item.Properties().tab(ItemGroups_CM.TEATIME).food(FoodBuilders.PC_PIZZAT)));
	public static final RegistryObject<Item> PC_PIZZAS = register("item_food_pizzas", () -> new Item(new Item.Properties().tab(ItemGroups_CM.TEATIME).food(FoodBuilders.PC_PIZZAS)));
	...
	public static final RegistryObject<Item> KETTLE_boil = register("item_kettle_boil", () -> new Item(new Item.Properties().craftRemainder(Items_Teatime.KETTLE_kara.get()).tab(ItemGroups_CM.TEATIME)));

	public static final RegistryObject<Item> KYUSU_kara = register("block_food_kyusu", () -> new Item(new Item.Properties().tab(ItemGroups_CM.TEATIME)));
	...
	public static final RegistryObject<Item> JPTEACUP = register("block_food_jpteacup_1", () -> new Dish_always(Dish_Blocks.JPTEACUP.get(), new Item.Properties().tab(ItemGroups_CM.TEATIME)));
	...
	public static final RegistryObject<Item> TEAPOT_kara = register("block_food_teapot", () -> new Item(new Item.Properties().tab(ItemGroups_CM.TEATIME)));
	...
	public static final RegistryObject<Item> ICECREAM = register("block_food_icecream_1", () -> new Dish_always(Dish_Blocks.ICECREAM.get(), (new Item.Properties()).tab(ItemGroups_CM.TEATIME)));
	...
	public static final RegistryObject<Item> FCHEESE = register("item_food_cheesef", () -> new Item(new Item.Properties().tab(ItemGroups_CM.TEATIME).food(FoodBuilders.FCHEESE)));
	public static final RegistryObject<Item> PC_CHEESE = register("item_food_cheese", () -> new Item(new Item.Properties().tab(ItemGroups_CM.TEATIME).food(FoodBuilders.PC_CHEESE)));
	...
	/* FOOD */
	public static final RegistryObject<Item> CAKE = register("item_food_cake", () -> new Item(new Item.Properties().tab(ItemGroups_CM.TEATIME).food(FoodBuilders.CAKE)));
	public static final RegistryObject<Item> BUN = register("item_food_bun", () -> new Item(new Item.Properties().tab(ItemGroups_CM.TEATIME).food(FoodBuilders.BUN)));
	public static final RegistryObject<Item> SCONE = register("item_food_scone", () -> new Item(new Item.Properties().tab(ItemGroups_CM.TEATIME).food(FoodBuilders.SCONE)));
	public static final RegistryObject<Item> SENBEI = register("item_food_senbei", () -> new AddInfo_Item(new Item.Properties().tab(ItemGroups_CM.TEATIME).food(FoodBuilders.SENBEI)));
	public static final RegistryObject<Item> TOUFU = register("item_food_toufu", () -> new Item(new Item.Properties().tab(ItemGroups_CM.TEATIME).food(FoodBuilders.TOUFU)));

	public static final RegistryObject<Item> CHICKENSAND = register("item_food_chickensand", () -> new Item(new Item.Properties().tab(ItemGroups_CM.TEATIME).food(FoodBuilders.CHICKENSAND)));
	public static final RegistryObject<Item> EGGSAND = register("item_food_eggsand", () -> new Item(new Item.Properties().tab(ItemGroups_CM.TEATIME).food(FoodBuilders.EGGSAND)));

	public static final RegistryObject<Item> KIRIMI_S = register("item_food_kirimi_salmon", () -> new AddInfo_Item(new Item.Properties().tab(ItemGroups_CM.TEATIME).food(FoodBuilders.KIRIMI)));
	public static final RegistryObject<Item> KIRIMI_F = register("item_food_kirimi_fish", () -> new AddInfo_Item(new Item.Properties().tab(ItemGroups_CM.TEATIME).food(FoodBuilders.KIRIMI)));
	public static final RegistryObject<Item> KIRIMI_B = register("item_food_kirimi_beef", () -> new AddInfo_Item(new Item.Properties().tab(ItemGroups_CM.TEATIME).food(FoodBuilders.KIRIMI)));
	public static final RegistryObject<Item> KIRIMI_T = register("item_food_kirimi_tamago", () -> new AddInfo_Item(new Item.Properties().tab(ItemGroups_CM.TEATIME).food(FoodBuilders.KIRIMI)));

	public static final RegistryObject<Item> SUSHI_S = register("item_food_sushi_salmon", () -> new Item(new Item.Properties().tab(ItemGroups_CM.TEATIME).food(FoodBuilders.SUSHI)));
	public static final RegistryObject<Item> SUSHI_F = register("item_food_sushi_fish", () -> new Item(new Item.Properties().tab(ItemGroups_CM.TEATIME).food(FoodBuilders.SUSHI)));
	public static final RegistryObject<Item> SUSHI_B = register("item_food_sushi_beef", () -> new Item(new Item.Properties().tab(ItemGroups_CM.TEATIME).food(FoodBuilders.SUSHI)));
	public static final RegistryObject<Item> SUSHI_T = register("item_food_sushi_tamago", () -> new Item(new Item.Properties().tab(ItemGroups_CM.TEATIME).food(FoodBuilders.SUSHI)));

	public static final RegistryObject<Item> SHOUYUSUSHI_S = register("item_food_sushishouyu_salmon", () -> new Item(new Item.Properties().tab(ItemGroups_CM.TEATIME).food(FoodBuilders.SHOUYUSUSHI_S)));
	public static final RegistryObject<Item> SHOUYUSUSHI_F = register("item_food_sushishouyu_fish", () -> new Item(new Item.Properties().tab(ItemGroups_CM.TEATIME).food(FoodBuilders.SHOUYUSUSHI_F)));
	public static final RegistryObject<Item> SHOUYUSUSHI_B = register("item_food_sushishouyu_beef", () -> new Item(new Item.Properties().tab(ItemGroups_CM.TEATIME).food(FoodBuilders.SHOUYUSUSHI_B)));
	public static final RegistryObject<Item> SHOUYUSUSHI_T = register("item_food_sushishouyu_tamago", () -> new Item(new Item.Properties().tab(ItemGroups_CM.TEATIME).food(FoodBuilders.SHOUYUSUSHI_T)));
	...
	public static final RegistryObject<Item> NORI_N = register("item_food_norinama", () -> new Item(new Item.Properties().tab(ItemGroups_CM.TEATIME)));
	public static final RegistryObject<Item> NORI_I = register("item_food_noriita", () -> new Item(new Item.Properties().tab(ItemGroups_CM.TEATIME).food(FoodBuilders.NORI_I)));
	public static final RegistryObject<Item> ONIGIRI = register("item_food_onigiri", () -> new Item(new Item.Properties().tab(ItemGroups_CM.TEATIME).food(FoodBuilders.ONIGIRI)));
	public static final RegistryObject<Item> ONIGIRI_SHAKE = register("item_food_onigirishake", () -> new Item(new Item.Properties().tab(ItemGroups_CM.TEATIME).food(FoodBuilders.ONIGIRISHAKE)));
	public static final RegistryObject<Item> ONIGIRI_TAKE = register("item_food_onigiritakenoko", () -> new Item(new Item.Properties().tab(ItemGroups_CM.TEATIME).food(FoodBuilders.ONIGIRI_TAKEKURI)));
	public static final RegistryObject<Item> ONIGIRI_KURI = register("item_food_onigirikuri", () -> new Item(new Item.Properties().tab(ItemGroups_CM.TEATIME).food(FoodBuilders.ONIGIRI_TAKEKURI)));
	public static final RegistryObject<Item> FUTOMAKI = register("item_food_futomaki", () -> new Item(new Item.Properties().tab(ItemGroups_CM.TEATIME).food(FoodBuilders.FUTOMAKI)));

	public static final RegistryObject<Item> KUSHI_SAKANA = register("item_kushi_sakana", () -> new AddInfo_Item(new Item.Properties().tab(ItemGroups_CM.TEATIME)));
	public static final RegistryObject<Item> KUSHI_SAKANA_C = register("item_kushi_sakana_c", () -> new FoodNeed_addItem(new Item.Properties().tab(ItemGroups_CM.TEATIME)));
	...
	public static final RegistryObject<Item> CUT_IKA = register("item_squid_cut", () -> new Item(new Item.Properties().tab(ItemGroups_CM.TEATIME).food(FoodBuilders.CUT_IKA)));
	public static final RegistryObject<Item> COOKED_IKA = register("item_squid_cooked", () -> new Item(new Item.Properties().tab(ItemGroups_CM.TEATIME).food(FoodBuilders.COOKED_IKA)));
	public static final RegistryObject<Item> IKA = register("item_squid_raw", () -> new AddInfo_Item(new Item.Properties().tab(ItemGroups_CM.TEATIME).craftRemainder(Items_Teatime.CUT_IKA.get())));	
	...
	public static final RegistryObject<Item> HAMAGURI_COOK = register("item_food_hamaguri", () -> new FoodNeed_addItem(new Item.Properties().tab(ItemGroups_CM.TEATIME)));
