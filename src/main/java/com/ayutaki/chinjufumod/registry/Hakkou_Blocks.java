...
public class Hakkou_Blocks {
	...
	public static Block KOUBOBOT_full = register("block_bin_koubo_f", new Bot_Koubo(stoneState().tickRandomly()));
	public static Block NYUSANBOT_full = register("block_bin_nyusan_f", new Bot_Nyusan(stoneState().tickRandomly()));
	...
	public static Block KINOKO_TARU = register("block_taru_kinoko_f", new Tana_Kinoko(taruRandom()));
	public static Block KONBU_TARU = register("block_taru_konbu_f", new Tana_Konbu(taruRandom()));
	public static Block NORI_TARU = register("block_taru_nori_f", new Tana_Nori(taruRandom()));
	public static Block KOUCHA_TARU = register("block_taru_koucha_f", new Tana_Koucha(taruRandom()));
	public static Block PEPPER_TARU = register("block_taru_pepper_f", new Tana_Pepper(taruRandom()));
