...
public class Items_Chinjufu {
	...
	public static Item ADMIRAL_STAMP_B = register("item_admiralstamp_b", new AdmiralStamp(ChinjufuMod_Blocks.I_ADMIRAL_STAMP, new Item.Properties().maxStackSize(1).maxDamage(16).group(ItemGroups_CM.CHINJUFU)));
