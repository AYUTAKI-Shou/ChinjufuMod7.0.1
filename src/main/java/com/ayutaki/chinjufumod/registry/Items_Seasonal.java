...
public class Items_Seasonal {
	...
	public static Item WARAHAI = register("item_warahai", new Warahai_Item(new Item.Properties()));
	...
	/** 6.4.1 **/ public static Item ZUNDOU_AKU = register("block_zundou_aku", new Seasonal_noFuel(Dish_Blocks.ZUNDOU_AKU, new Item.Properties().craftRemainder(Items_Teatime.ZUNDOU)));
	...
	public static Item KURI = register("item_chestnut", new AddInfo_Item(new Item.Properties().tab(ItemGroups_CM.SEASONAL)));
	public static Item KURI_ROAST = register("item_food_chestnut", new Item(new Item.Properties().tab(ItemGroups_CM.SEASONAL).food(FoodBuilders.KURI_ROAST)));
	public static Item KURI_BOIL = register("item_chestnut_boil", new AddInfo_Item(new Item.Properties().tab(ItemGroups_CM.SEASONAL).craftRemainder(Items.BOWL)));
	public static Item KURI_MASH = register("item_chestnut_mash", new AddInfo_Item(new Item.Properties().tab(ItemGroups_CM.SEASONAL).craftRemainder(Items.BOWL)));
	...
	public static Item KURI_SWEET = register("item_food_chestnutsweet", new AddInfo_Item(new Item.Properties().tab(ItemGroups_CM.SEASONAL).food(FoodBuilders.KURI_SWEET)));
	public static Item KURI_CHOCO = register("item_food_chestnutchoco", new AddInfo_Item(new Item.Properties().tab(ItemGroups_CM.SEASONAL).food(FoodBuilders.KURI_CHOCO)));
	public static Item TAKENOKO = register("block_takenoko", new Seasonal_noFuel(Wood_Blocks.TAKENOKO, new Item.Properties()));
	public static Item TAKENOKO_ROAST = register("item_food_takenoko", new Item(new Item.Properties().tab(ItemGroups_CM.SEASONAL).food(FoodBuilders.TAKENOKO_ROAST)));
	...
	public static Item FOOD_WATAGASHI = register("item_food_watagashi", new FoodAnytime_addItem(new Item.Properties().tab(ItemGroups_CM.SEASONAL)));
	public static Item FOOD_WATAGASHI_A = register("item_food_watagashi_y", new FoodAnytime_addItem(new Item.Properties().tab(ItemGroups_CM.SEASONAL)));
	public static Item FOOD_WATAGASHI_C = register("item_food_watagashi_p", new FoodAnytime_addItem(new Item.Properties().tab(ItemGroups_CM.SEASONAL)));
	public static Item FOOD_WATAGASHI_G = register("item_food_watagashi_r", new FoodAnytime_addItem(new Item.Properties().tab(ItemGroups_CM.SEASONAL)));
	public static Item FOOD_WATAGASHI_T = register("item_food_watagashi_g", new FoodAnytime_addItem(new Item.Properties().tab(ItemGroups_CM.SEASONAL)));
