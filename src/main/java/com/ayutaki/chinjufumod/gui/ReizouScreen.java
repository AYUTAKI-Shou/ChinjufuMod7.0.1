...
public class ReizouScreen extends GuiContainer {
	...
	private final Reizou_TileEntity tileEntity;
	
	public ReizouScreen(InventoryPlayer playerInventory, Reizou_TileEntity chestInventory, EntityPlayer player) {
		super(new ReizouMenu(playerInventory, chestInventory, player));
