...
public class CMEvents {
	...
	/* Item Sound */
	public static void soundPaint(World iworld, EntityPlayer playerIn, BlockPos pos) {
		iworld.playSound(playerIn, pos, SoundEvents_CM.PAINT, SoundCategory.BLOCKS, 1.0F, 0.8F); }
	
	public static void soundChisel(World iworld, EntityPlayer playerIn, BlockPos pos) {
		iworld.playSound(playerIn, pos, SoundEvents.BLOCK_STONE_BREAK, SoundCategory.BLOCKS, 1.0F, 0.8F); }
	
	public static void soundChiselWood(World iworld, EntityPlayer playerIn, BlockPos pos) {
		iworld.playSound(playerIn, pos, SoundEvents.BLOCK_WOOD_BREAK, SoundCategory.BLOCKS, 1.0F, 0.8F); }
	
	public static void soundKumade(World iworld, EntityPlayer playerIn, BlockPos pos) {
		iworld.playSound(playerIn, pos, SoundEvents.BLOCK_SAND_PLACE, SoundCategory.BLOCKS, 1.0F, 0.8F); }
	
	public static void soundWash(World iworld, EntityPlayer playerIn, BlockPos pos) {
	...
	public static void textEarlyCollect(World worldIn, BlockPos pos, EntityPlayer playerIn) {
		worldIn.playSound(null, pos, SoundEvents_CM.TOUCH_BLOCK, SoundCategory.BLOCKS, 1.0F, 0.75F);
		playerIn.sendStatusMessage(new TextComponentTranslation("text.chinjufumod.rightclick.earlycollect.name", new Object[0]), true); }
	
	public static void textEarlyUse(World worldIn, BlockPos pos, EntityPlayer playerIn) {
		worldIn.playSound(null, pos, SoundEvents_CM.TOUCH_BLOCK, SoundCategory.BLOCKS, 1.0F, 0.75F);
		playerIn.sendStatusMessage(new TextComponentTranslation("text.chinjufumod.rightclick.earlyuse.name", new Object[0]), true); }
	
	public static void textFullItem(World worldIn, BlockPos pos, EntityPlayer playerIn) {
		worldIn.playSound(null, pos, SoundEvents_CM.TOUCH_BLOCK, SoundCategory.BLOCKS, 1.0F, 0.75F);
		playerIn.sendStatusMessage(new TextComponentTranslation("text.chinjufumod.rightclick.fullitem.name", new Object[0]), true); }
	
	public static void textNoPlace(World worldIn, BlockPos pos, EntityPlayer playerIn) {
		worldIn.playSound(null, pos, SoundEvents_CM.TOUCH_BLOCK, SoundCategory.BLOCKS, 1.0F, 0.75F);
		playerIn.sendStatusMessage(new TextComponentTranslation("text.chinjufumod.rightclick.noplace.name", new Object[0]), true); }
	
	public static void textNotEnough_Items(World worldIn, BlockPos pos, EntityPlayer playerIn) {
		worldIn.playSound(null, pos, SoundEvents_CM.TOUCH_BLOCK, SoundCategory.BLOCKS, 1.0F, 0.75F);
		playerIn.sendStatusMessage(new TextComponentTranslation("text.chinjufumod.rightclick.notenough_items.name", new Object[0]), true); }
	
	public static void textNotHave(World worldIn, BlockPos pos, EntityPlayer playerIn) {
		worldIn.playSound(null, pos, SoundEvents_CM.TOUCH_BLOCK, SoundCategory.BLOCKS, 1.0F, 0.75F);
		playerIn.sendStatusMessage(new TextComponentTranslation("text.chinjufumod.rightclick.nothave.name", new Object[0]), true); }
	
	public static void textNotSneak(World worldIn, BlockPos pos, EntityPlayer playerIn) {
		worldIn.playSound(null, pos, SoundEvents_CM.TOUCH_BLOCK, SoundCategory.BLOCKS, 1.0F, 0.75F);
		playerIn.sendStatusMessage(new TextComponentTranslation("text.chinjufumod.rightclick.notsneak.name", new Object[0]), true); }
	
	public static void textIsBlocked(World worldIn, BlockPos pos, EntityPlayer playerIn) {
		worldIn.playSound(null, pos, SoundEvents_CM.TOUCH_BLOCK, SoundCategory.BLOCKS, 1.0F, 0.75F);
		playerIn.sendStatusMessage(new TextComponentTranslation("text.chinjufumod.rightclick.blocked.name", new Object[0]), true); }

	public static void textIsEmpty(World worldIn, BlockPos pos, EntityPlayer playerIn) {
		worldIn.playSound(null, pos, SoundEvents_CM.TOUCH_BLOCK, SoundCategory.BLOCKS, 1.0F, 0.75F);
		playerIn.sendStatusMessage(new TextComponentTranslation("text.chinjufumod.rightclick.empty.name", new Object[0]), true); }
	
	public static void textIsSleeping(World worldIn, BlockPos pos, EntityPlayer playerIn) {
		worldIn.playSound(null, pos, SoundEvents_CM.TOUCH_BLOCK, SoundCategory.BLOCKS, 1.0F, 0.75F);
		playerIn.sendStatusMessage(new TextComponentTranslation("text.chinjufumod.rightclick.sleeping.name", new Object[0]), true); }
	...
	public static void textRequestHeat(World worldIn, BlockPos pos, EntityPlayer playerIn) {
		worldIn.playSound(null, pos, SoundEvents_CM.TOUCH_BLOCK, SoundCategory.BLOCKS, 1.0F, 0.75F);
		playerIn.sendStatusMessage(new TextComponentTranslation("text.chinjufumod.rightclick.heat.name", new Object[0]), true); }
	
	public static void textRequestCool(World worldIn, BlockPos pos, EntityPlayer playerIn) {
		worldIn.playSound(null, pos, SoundEvents_CM.TOUCH_BLOCK, SoundCategory.BLOCKS, 1.0F, 0.75F);
		playerIn.sendStatusMessage(new TextComponentTranslation("text.chinjufumod.rightclick.cool.name", new Object[0]), true); }
	
	public static void textNotEnough_EXP(World worldIn, BlockPos pos, EntityPlayer playerIn) {
		worldIn.playSound(null, pos, SoundEvents_CM.TOUCH_BLOCK, SoundCategory.BLOCKS, 1.0F, 0.75F);
		playerIn.sendStatusMessage(new TextComponentTranslation("text.chinjufumod.rightclick.notenough_exp.name", new Object[0]), true); }
	
	public static void textNotDig(EntityPlayer playerIn) {
		playerIn.sendStatusMessage(new TextComponentTranslation("text.chinjufumod.rightclick.notdig.name", new Object[0]), true); }
	...
	public static void Consume1Item_Bottle(World worldIn, BlockPos pos, EntityPlayer playerIn, EnumHand hand) {
		ItemStack stack = playerIn.getHeldItem(hand);
		boolean mode = playerIn.capabilities.isCreativeMode;
		if (!mode) { stack.shrink(1); }
		if (mode) { } 
	...
	public static void Consume1Item_Bowl(World worldIn, BlockPos pos, EntityPlayer playerIn, EnumHand hand) {
		ItemStack stack = playerIn.getHeldItem(hand);
		boolean mode = playerIn.capabilities.isCreativeMode;
		if (!mode) { stack.shrink(1); }
		if (mode) { } 
	...
	public static void Consume1Item_Cheese(World worldIn, BlockPos pos, EntityPlayer playerIn, EnumHand hand) {
		ItemStack stack = playerIn.getHeldItem(hand);
		boolean mode = playerIn.capabilities.isCreativeMode;
		if (!mode) { stack.shrink(1); }
		if (mode) { } 
	...
	public static void Consume1Item_Dish(World worldIn, BlockPos pos, EntityPlayer playerIn, EnumHand hand) {
		ItemStack stack = playerIn.getHeldItem(hand);
		boolean mode = playerIn.capabilities.isCreativeMode;
		if (!mode) { stack.shrink(1); }
		if (mode) { } 
	...
	public static void Consume1Item_Flint(World worldIn, BlockPos pos, EntityPlayer playerIn, EnumHand hand) {
		ItemStack stack = playerIn.getHeldItem(hand);
		boolean mode = playerIn.capabilities.isCreativeMode;
		if (!mode) { stack.shrink(1); }
		if (mode) { } 
	...
	public static void Consume1Item_SnowB(World worldIn, BlockPos pos, EntityPlayer playerIn, EnumHand hand) {
		ItemStack stack = playerIn.getHeldItem(hand);
		boolean mode = playerIn.capabilities.isCreativeMode;
		if (!mode) { stack.shrink(1); }
		if (mode) { } 
	...
	public static void Consume1Item_SnowP(World worldIn, BlockPos pos, EntityPlayer playerIn, EnumHand hand) {
		ItemStack stack = playerIn.getHeldItem(hand);
		boolean mode = playerIn.capabilities.isCreativeMode;
		if (!mode) { stack.shrink(1); }
		if (mode) { } 
	...
	public static void Consume1Item_Splash(World worldIn, BlockPos pos, EntityPlayer playerIn, EnumHand hand) {
		ItemStack stack = playerIn.getHeldItem(hand);
		boolean mode = playerIn.capabilities.isCreativeMode;
		if (!mode) { stack.shrink(1); }
		if (mode) { } 
	...
	public static void Consume1Item_Stone(World worldIn, BlockPos pos, EntityPlayer playerIn, EnumHand hand) {
		ItemStack stack = playerIn.getHeldItem(hand);
		boolean mode = playerIn.capabilities.isCreativeMode;
		if (!mode) { stack.shrink(1); }
		if (mode) { } 
	...
	public static void Consume1Item_Tea(World worldIn, BlockPos pos, EntityPlayer playerIn, EnumHand hand) {
		ItemStack stack = playerIn.getHeldItem(hand);
		boolean mode = playerIn.capabilities.isCreativeMode;
		if (!mode) { stack.shrink(1); }
		if (mode) { } 
	...
	public static void Consume1Item_Wood(World worldIn, BlockPos pos, EntityPlayer playerIn, EnumHand hand) {
		ItemStack stack = playerIn.getHeldItem(hand);
		boolean mode = playerIn.capabilities.isCreativeMode;
		if (!mode) { stack.shrink(1); }
		if (mode) { } 
	...
	public static void Consume1Item_WDish(World worldIn, BlockPos pos, EntityPlayer playerIn, EnumHand hand) {
		ItemStack stack = playerIn.getHeldItem(hand);
		boolean mode = playerIn.capabilities.isCreativeMode;
		if (!mode) { stack.shrink(1); }
		if (mode) { } 
	...
	public static void Consume1Item_Write(World worldIn, BlockPos pos, EntityPlayer playerIn, EnumHand hand) {
		ItemStack stack = playerIn.getHeldItem(hand);
		boolean mode = playerIn.capabilities.isCreativeMode;
		if (!mode) { stack.shrink(1); }
		if (mode) { } 
	...
	public static void SoysauceTo2(World worldIn, BlockPos pos, EntityPlayer playerIn, EnumHand hand) {
		...
		if (!mode) { stack.shrink(1);
			if (stack.isEmpty()) { playerIn.inventory.addItemStackToInventory(new ItemStack(Items_Teatime.SHOUYU_bot_2)); }
	...
	public static void SoysauceTo3(World worldIn, BlockPos pos, EntityPlayer playerIn, EnumHand hand) {
		...
		if (!mode) { stack.shrink(1);
			if (stack.isEmpty()) { playerIn.inventory.addItemStackToInventory(new ItemStack(Items_Teatime.SHOUYU_bot_3)); }
	...
	public static void SoysauceTo4(World worldIn, BlockPos pos, EntityPlayer playerIn, EnumHand hand) {
		...
		if (!mode) { stack.shrink(1);
			if (stack.isEmpty()) { playerIn.inventory.addItemStackToInventory(new ItemStack(Items_Teatime.SHOUYU_bot_4)); }
	...
	/** Consume and Sound. **/
	public static void Consume_1Cloth(World worldIn, BlockPos pos, EntityPlayer playerIn, EnumHand hand) {
		ItemStack stack = playerIn.getHeldItem(hand);
		boolean mode = playerIn.capabilities.isCreativeMode;
		if (!mode) { stack.shrink(1); }
		if (mode) { }
	...
	public static void Consume_1Wood(World worldIn, BlockPos pos, EntityPlayer playerIn, EnumHand hand) {
		ItemStack stack = playerIn.getHeldItem(hand);
		boolean mode = playerIn.capabilities.isCreativeMode;
		if (!mode) { stack.shrink(1); }
		if (mode) { }
	...
	public static void Consume_1Stone(World worldIn, BlockPos pos, EntityPlayer playerIn, EnumHand hand) {
		ItemStack stack = playerIn.getHeldItem(hand);
		boolean mode = playerIn.capabilities.isCreativeMode;
		if (!mode) { stack.shrink(1); }
		if (mode) { }
	...
	public static void Consume_1Metal(World worldIn, BlockPos pos, EntityPlayer playerIn, EnumHand hand) {
		ItemStack stack = playerIn.getHeldItem(hand);
		boolean mode = playerIn.capabilities.isCreativeMode;
		if (!mode) { stack.shrink(1); }
		if (mode) { }
	...
	public static void Consume_1Grass(World worldIn, BlockPos pos, EntityPlayer playerIn, EnumHand hand) {
		ItemStack stack = playerIn.getHeldItem(hand);
		boolean mode = playerIn.capabilities.isCreativeMode;
		if (!mode) { stack.shrink(1); }
		if (mode) { }
	...
	public static void textNoSpace(World worldIn, EntityPlayer playerIn) {
		worldIn.playSound(null, playerIn.posX, playerIn.posY, playerIn.posZ, SoundEvents_CM.TOUCH_BLOCK, SoundCategory.BLOCKS, 1.0F, 0.75F);
		playerIn.sendStatusMessage(new TextComponentTranslation("text.chinjufumod.rightclick.noplace.name", new Object[0]), true); }
