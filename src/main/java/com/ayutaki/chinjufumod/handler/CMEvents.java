...
public class CMEvents {
	...
	public static void textEarlyCollect(Level worldIn, BlockPos pos, Player playerIn) {
		worldIn.playSound(null, pos, SoundEvents_CM.TOUCH_BLOCK.get(), SoundSource.BLOCKS, 1.0F, 0.75F);
		playerIn.displayClientMessage(new TranslatableComponent("text.chinjufumod.rightclick.earlycollect"), true); }
	
	public static void textEarlyUse(Level worldIn, BlockPos pos, Player playerIn) {
		worldIn.playSound(null, pos, SoundEvents_CM.TOUCH_BLOCK.get(), SoundSource.BLOCKS, 1.0F, 0.75F);
		playerIn.displayClientMessage(new TranslatableComponent("text.chinjufumod.rightclick.earlyuse"), true); }
	
	public static void textFullItem(Level worldIn, BlockPos pos, Player playerIn) {
		worldIn.playSound(null, pos, SoundEvents_CM.TOUCH_BLOCK.get(), SoundSource.BLOCKS, 1.0F, 0.75F);
		playerIn.displayClientMessage(new TranslatableComponent("text.chinjufumod.rightclick.fullitem"), true); }
	
	public static void textNoPlace(Level worldIn, BlockPos pos, Player playerIn) {
		worldIn.playSound(null, pos, SoundEvents_CM.TOUCH_BLOCK.get(), SoundSource.BLOCKS, 1.0F, 0.75F);
		playerIn.displayClientMessage(new TranslatableComponent("text.chinjufumod.rightclick.noplace"), true); }
	
	public static void textNotEnough_Items(Level worldIn, BlockPos pos, Player playerIn) {
		worldIn.playSound(null, pos, SoundEvents_CM.TOUCH_BLOCK.get(), SoundSource.BLOCKS, 1.0F, 0.75F);
		playerIn.displayClientMessage(new TranslatableComponent("text.chinjufumod.rightclick.notenough_items"), true); }
	
	public static void textNotHave(Level worldIn, BlockPos pos, Player playerIn) {
		worldIn.playSound(null, pos, SoundEvents_CM.TOUCH_BLOCK.get(), SoundSource.BLOCKS, 1.0F, 0.75F);
		playerIn.displayClientMessage(new TranslatableComponent("text.chinjufumod.rightclick.nothave"), true); }
	
	public static void textNotSneak(Level worldIn, BlockPos pos, Player playerIn) {
		worldIn.playSound(null, pos, SoundEvents_CM.TOUCH_BLOCK.get(), SoundSource.BLOCKS, 1.0F, 0.75F);
		playerIn.displayClientMessage(new TranslatableComponent("text.chinjufumod.rightclick.notsneak"), true); }
	
	public static void textIsBlocked(Level worldIn, BlockPos pos, Player playerIn) {
		worldIn.playSound(null, pos, SoundEvents_CM.TOUCH_BLOCK.get(), SoundSource.BLOCKS, 1.0F, 0.75F);
		playerIn.displayClientMessage(new TranslatableComponent("text.chinjufumod.rightclick.blocked"), true); }

	public static void textIsEmpty(Level worldIn, BlockPos pos, Player playerIn) {
		worldIn.playSound(null, pos, SoundEvents_CM.TOUCH_BLOCK.get(), SoundSource.BLOCKS, 1.0F, 0.75F);
		playerIn.displayClientMessage(new TranslatableComponent("text.chinjufumod.rightclick.empty"), true); }
	
	public static void textIsSleeping(Level worldIn, BlockPos pos, Player playerIn) {
		worldIn.playSound(null, pos, SoundEvents_CM.TOUCH_BLOCK.get(), SoundSource.BLOCKS, 1.0F, 0.75F);
		playerIn.displayClientMessage(new TranslatableComponent("text.chinjufumod.rightclick.sleeping"), true); }
	...
	public static void textRequestHeat(Level worldIn, BlockPos pos, Player playerIn) {
		worldIn.playSound(null, pos, SoundEvents_CM.TOUCH_BLOCK.get(), SoundSource.BLOCKS, 1.0F, 0.75F);
		playerIn.displayClientMessage(new TranslatableComponent("text.chinjufumod.rightclick.heat"), true); }
	
	public static void textRequestCool(Level worldIn, BlockPos pos, Player playerIn) {
		worldIn.playSound(null, pos, SoundEvents_CM.TOUCH_BLOCK.get(), SoundSource.BLOCKS, 1.0F, 0.75F);
		playerIn.displayClientMessage(new TranslatableComponent("text.chinjufumod.rightclick.cool"), true); }
	
	public static void textNotEnough_EXP(Level worldIn, BlockPos pos, Player playerIn) {
		worldIn.playSound(null, pos, SoundEvents_CM.TOUCH_BLOCK.get(), SoundSource.BLOCKS, 1.0F, 0.75F);
		playerIn.displayClientMessage(new TranslatableComponent("text.chinjufumod.rightclick.notenough_exp"), true); }
	
	public static void textNotDig(Player playerIn) {
		playerIn.displayClientMessage(new TranslatableComponent("text.chinjufumod.rightclick.notdig"), true); }
