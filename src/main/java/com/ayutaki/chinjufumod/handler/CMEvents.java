...
public class CMEvents {
	...
	public static void soundBottleFill(World worldIn, BlockPos pos) {
		worldIn.playSound(null, pos, SoundEvents.BOTTLE_FILL, SoundCategory.PLAYERS, 0.7F, 1.0F); }
	...
	public static void soundBucketFill(World worldIn, BlockPos pos) {
		worldIn.playSound(null, pos, SoundEvents.BUCKET_FILL, SoundCategory.PLAYERS, 0.7F, 1.0F); }
	...
	public static void soundKotePlace(World worldIn, BlockPos pos) {
		worldIn.playSound(null, pos, SoundEvents.METAL_HIT, SoundCategory.BLOCKS, 0.8F, 3.0F); }
	...
	public static void soundSakeBottleFill(World worldIn, BlockPos pos) {
		worldIn.playSound(null, pos, SoundEvents.BOTTLE_FILL, SoundCategory.PLAYERS, 0.7F, 0.8F); }
	...
	public static void soundSnowPlace(World worldIn, BlockPos pos) {
		worldIn.playSound(null, pos, SoundEvents.SNOW_PLACE, SoundCategory.BLOCKS, 0.7F, 1.2F); } //keep
	...
	public static void textNotDig(PlayerEntity playerIn) {
		playerIn.displayClientMessage(new TranslationTextComponent("text.chinjufumod.rightclick.notdig"), true); }
	...
	public static void Consume1Item_Bowl(World worldIn, BlockPos pos, PlayerEntity playerIn, Hand hand) {
		...
		if (!mode) { stack.shrink(1); }
		if (mode) { } 
		worldIn.playSound(null, pos, SoundEvents.BUCKET_FILL, SoundCategory.PLAYERS, 0.8F, 1.2F); }
	...
	public static void MIZUOKEfull_Empty(World worldIn, BlockPos pos, PlayerEntity playerIn, Hand hand) {
		...
		if (!mode) { stack.shrink(1);
			if (stack.isEmpty()) { playerIn.inventory.add(new ItemStack(Items_Teatime.MIZUOKE)); }
	...
	public static void SoysauceTo2(World worldIn, BlockPos pos, PlayerEntity playerIn, Hand hand) {
		...
		if (!mode) { stack.shrink(1);
			if (stack.isEmpty()) { playerIn.inventory.add(new ItemStack(Items_NoTab.SHOUYU_bot_2)); }
			else if (!playerIn.inventory.add(new ItemStack(Items_NoTab.SHOUYU_bot_2))) {
				playerIn.drop(new ItemStack(Items_NoTab.SHOUYU_bot_2), false); } }
		if (mode) { } 
	...
	public static void SoysauceTo3(World worldIn, BlockPos pos, PlayerEntity playerIn, Hand hand) {
		...
		if (!mode) { stack.shrink(1);
			if (stack.isEmpty()) { playerIn.inventory.add(new ItemStack(Items_NoTab.SHOUYU_bot_3)); }
			else if (!playerIn.inventory.add(new ItemStack(Items_NoTab.SHOUYU_bot_3))) {
				playerIn.drop(new ItemStack(Items_NoTab.SHOUYU_bot_3), false); } }
		if (mode) { } 
	...
	public static void SoysauceTo4(World worldIn, BlockPos pos, PlayerEntity playerIn, Hand hand) {
		...
		if (!mode) { stack.shrink(1);
			if (stack.isEmpty()) { playerIn.inventory.add(new ItemStack(Items_NoTab.SHOUYU_bot_4)); }
			else if (!playerIn.inventory.add(new ItemStack(Items_NoTab.SHOUYU_bot_4))) {
				playerIn.drop(new ItemStack(Items_NoTab.SHOUYU_bot_4), false); } }
		if (mode) { } 
