...
public class ParticleManager_CM {
	...
	public static void registerFactories(ParticleFactoryRegisterEvent event) {
		...
		particleManager.register(ParticleTypes_CM.AMMO_PT, Particle_Ammo.Factory::new);
		particleManager.register(ParticleTypes_CM.SHOOT_PT, Particle_ShootK.Factory::new);
		particleManager.register(ParticleTypes_CM.SHOOTL_PT, Particle_ShootL.Factory::new);
		particleManager.register(ParticleTypes_CM.SHOOTM_PT, Particle_ShootM.Factory::new);
		particleManager.register(ParticleTypes_CM.MARK_PT, Particle_Mark.Factory::new);
	}
}
