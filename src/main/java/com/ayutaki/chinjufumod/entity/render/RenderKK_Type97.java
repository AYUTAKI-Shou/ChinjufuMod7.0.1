...
public class RenderKK_Type97 extends EntityRenderer<KK_Type97Entity> {
	...
	public RenderKK_Type97(EntityRendererProvider.Context renderManager, ItemRenderer itemRenderer) {
		super(renderManager);
	...
	public void render(KK_Type97Entity entity, float entityYaw, float partialTicks, PoseStack matrixStack, MultiBufferSource buffer, int packedLight) {
