...
public class RenderKB_SBD extends EntityRenderer<KB_SBDEntity> {
	...
	public RenderKB_SBD(EntityRendererProvider.Context renderManager, ItemRenderer itemRenderer) {
		super(renderManager);
	...
	public void render(KB_SBDEntity entity, float entityYaw, float partialTicks, PoseStack matrixStack, MultiBufferSource buffer, int packedLight) {
