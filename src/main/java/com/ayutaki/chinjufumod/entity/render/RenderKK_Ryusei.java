...
public class RenderKK_Ryusei extends EntityRenderer<KK_RyuseiEntity> {
	...
	public RenderKK_Ryusei(EntityRendererProvider.Context renderManager, ItemRenderer itemRenderer) {
		super(renderManager);
	...
	public void render(KK_RyuseiEntity entity, float entityYaw, float partialTicks, PoseStack matrixStack, MultiBufferSource buffer, int packedLight) {
