...
public class RenderKB_F4U extends EntityRenderer<KB_F4UEntity> {
	...
	public RenderKB_F4U(EntityRendererProvider.Context renderManager, ItemRenderer itemRenderer) {
		super(renderManager);
	...
	public void render(KB_F4UEntity entity, float entityYaw, float partialTicks, PoseStack matrixStack, MultiBufferSource buffer, int packedLight) {
