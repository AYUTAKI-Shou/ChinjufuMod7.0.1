...
public class RenderKK_TBF extends EntityRenderer<KK_TBFEntity> {
	...
	public RenderKK_TBF(EntityRendererProvider.Context renderManager, ItemRenderer itemRenderer) {
		super(renderManager);
	...
	public void render(KK_TBFEntity entity, float entityYaw, float partialTicks, PoseStack matrixStack, MultiBufferSource buffer, int packedLight) {
