...
public class RenderKB_TypeZero extends EntityRenderer<KB_TypeZeroEntity> {
	...
	public RenderKB_TypeZero(EntityRendererProvider.Context renderManager, ItemRenderer itemRenderer) {
		super(renderManager);
	...
	public void render(KB_TypeZeroEntity entity, float entityYaw, float partialTicks, PoseStack matrixStack, MultiBufferSource buffer, int packedLight) {
