...
public class RenderKK_Barracuda extends EntityRenderer<KK_BarracudaEntity> {
	...
	public RenderKK_Barracuda(EntityRendererProvider.Context renderManager, ItemRenderer itemRenderer) {
		super(renderManager);
	...
	public void render(KK_BarracudaEntity entity, float entityYaw, float partialTicks, PoseStack matrixStack, MultiBufferSource buffer, int packedLight) {
