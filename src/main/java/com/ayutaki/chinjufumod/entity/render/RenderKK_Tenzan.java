...
public class RenderKK_Tenzan extends EntityRenderer<KK_TenzanEntity> {
	...
	public RenderKK_Tenzan(EntityRendererProvider.Context renderManager, ItemRenderer itemRenderer) {
		super(renderManager);
	...
	public void render(KK_TenzanEntity entity, float entityYaw, float partialTicks, PoseStack matrixStack, MultiBufferSource buffer, int packedLight) {
