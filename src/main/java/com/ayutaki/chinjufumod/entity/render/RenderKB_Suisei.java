...
public class RenderKB_Suisei extends EntityRenderer<KB_SuiseiEntity> {
	...
	public RenderKB_Suisei(EntityRendererProvider.Context renderManager, ItemRenderer itemRenderer) {
		super(renderManager);
	...
	public void render(KB_SuiseiEntity entity, float entityYaw, float partialTicks, PoseStack matrixStack, MultiBufferSource buffer, int packedLight) {
