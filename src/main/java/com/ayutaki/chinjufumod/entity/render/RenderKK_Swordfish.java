...
public class RenderKK_Swordfish extends EntityRenderer<KK_SwordfishEntity> {
	...
	public RenderKK_Swordfish(EntityRendererProvider.Context renderManager, ItemRenderer itemRenderer) {
		super(renderManager);
	...
	public void render(KK_SwordfishEntity entity, float entityYaw, float partialTicks, PoseStack matrixStack, MultiBufferSource buffer, int packedLight) {
