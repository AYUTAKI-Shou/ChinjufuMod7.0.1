...
public class CafeTable extends BaseUnitBlock {
	...
	protected static final VoxelShape FTTT = Shapes.or(Block.box(0.0D, 15.0D, 0.0D, 16.0D, 16.0D, 16.0D),
			Block.box(0.0D, 14.0D, 0.0D, 15.0D, 15.0D, 16.0D));
	protected static final VoxelShape TTTF = Shapes.or(Block.box(0.0D, 15.0D, 0.0D, 16.0D, 16.0D, 16.0D),
			Block.box(1.0D, 14.0D, 0.0D, 16.0D, 15.0D, 16.0D));
	protected static final VoxelShape TTFT = Shapes.or(Block.box(0.0D, 15.0D, 0.0D, 16.0D, 16.0D, 16.0D),
			Block.box(0.0D, 14.0D, 0.0D, 16.0D, 15.0D, 15.0D));
	protected static final VoxelShape TFTT = Shapes.or(Block.box(0.0D, 15.0D, 0.0D, 16.0D, 16.0D, 16.0D),
			Block.box(0.0D, 14.0D, 1.0D, 16.0D, 15.0D, 16.0D));
	
	public CafeTable(BlockBehaviour.Properties properties) {
		super(properties);
	}
