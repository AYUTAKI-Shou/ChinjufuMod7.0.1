...
public class LowDesk extends BaseUnitBlock {
	...
	protected static final VoxelShape FFFF = Shapes.or(Block.box(0.0D, 6.0D, 0.0D, 16.0D, 8.0D, 16.0D),
	...
	protected static final VoxelShape TTFF = Shapes.or(Block.box(0.0D, 6.0D, 0.0D, 16.0D, 8.0D, 16.0D),
			Block.box(0.0D, 0.0D, 13.0D, 3.0D, 6.0D, 16.0D));
	protected static final VoxelShape FTFT = Shapes.or(Block.box(0.0D, 6.0D, 0.0D, 16.0D, 8.0D, 16.0D),
			Block.box(13.0D, 0.0D, 13.0D, 16.0D, 6.0D, 16.0D));
	protected static final VoxelShape TFTF = Shapes.or(Block.box(0.0D, 6.0D, 0.0D, 16.0D, 8.0D, 16.0D),
			Block.box(0.0D, 0.0D, 0.0D, 3.0D, 6.0D, 3.0D));
	protected static final VoxelShape FFTT = Shapes.or(Block.box(0.0D, 6.0D, 0.0D, 16.0D, 8.0D, 16.0D),
			Block.box(13.0D, 0.0D, 0.0D, 16.0D, 6.0D, 3.0D));

	protected static final VoxelShape FTFF = Shapes.or(Block.box(0.0D, 6.0D, 0.0D, 16.0D, 8.0D, 16.0D),
			Block.box(0.0D, 0.0D, 14.0D, 2.0D, 6.0D, 16.0D),
			Block.box(14.0D, 0.0D, 14.0D, 16.0D, 6.0D, 16.0D));
	protected static final VoxelShape FFTF = Shapes.or(Block.box(0.0D, 6.0D, 0.0D, 16.0D, 8.0D, 16.0D),
			Block.box(0.0D, 0.0D, 0.0D, 2.0D, 6.0D, 2.0D),
			Block.box(14.0D, 0.0D, 0.0D, 16.0D, 6.0D, 2.0D));
	protected static final VoxelShape TFFF = Shapes.or(Block.box(0.0D, 6.0D, 0.0D, 16.0D, 8.0D, 16.0D),
			Block.box(0.0D, 0.0D, 0.0D, 2.0D, 6.0D, 2.0D),
			Block.box(0.0D, 0.0D, 14.0D, 2.0D, 6.0D, 16.0D));
	protected static final VoxelShape FFFT = Shapes.or(Block.box(0.0D, 6.0D, 0.0D, 16.0D, 8.0D, 16.0D),
			Block.box(14.0D, 0.0D, 0.0D, 16.0D, 6.0D, 2.0D),
			Block.box(14.0D, 0.0D, 14.0D, 16.0D, 6.0D, 16.0D));
	
	public LowDesk(BlockBehaviour.Properties properties) {
		super(properties);
	}
