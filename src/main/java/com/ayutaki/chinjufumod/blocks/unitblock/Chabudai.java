...
public class Chabudai extends BaseUnitBlock {
	...
	protected static final VoxelShape FFFF = Shapes.or(Block.box(0.0D, 7.0D, 5.0D, 1.0D, 8.0D, 11.0D),
	...
	protected static final VoxelShape TTFF = Shapes.or(Block.box(13.0D, 7.0D, 13.0D, 16.0D, 8.0D, 14.0D),
	...
	protected static final VoxelShape FTFT = Shapes.or(Block.box(0.0D, 7.0D, 13.0D, 3.0D, 8.0D, 14.0D),
	...
	protected static final VoxelShape TFTF = Shapes.or(Block.box(13.0D, 7.0D, 2.0D, 16.0D, 8.0D, 3.0D),
	...
	protected static final VoxelShape FFTT = Shapes.or(Block.box(0.0D, 7.0D, 2.0D, 3.0D, 8.0D, 3.0D),
	...
	protected static final VoxelShape FTTT = Shapes.or(Block.box(0.0D, 7.0D, 0.0D, 15.0D, 8.0D, 16.0D),
			Block.box(15.0D, 7.0D, 3.0D, 16.0D, 8.0D, 13.0D));
	protected static final VoxelShape TTTF = Shapes.or(Block.box(1.0D, 7.0D, 0.0D, 16.0D, 8.0D, 16.0D),
			Block.box(0.0D, 7.0D, 3.0D, 1.0D, 8.0D, 13.0D));
	protected static final VoxelShape TTFT = Shapes.or(Block.box(0.0D, 7.0D, 0.0D, 16.0D, 8.0D, 15.0D),
			Block.box(3.0D, 7.0D, 15.0D, 13.0D, 8.0D, 16.0D));
	protected static final VoxelShape TFTT = Shapes.or(Block.box(0.0D, 7.0D, 1.0D, 16.0D, 8.0D, 16.0D),
			Block.box(3.0D, 7.0D, 0.0D, 13.0D, 8.0D, 1.0D));
	
	public Chabudai(BlockBehaviour.Properties properties) {
		super(properties);
	}
	...
	public void appendHoverText(ItemStack stack, @Nullable BlockGetter worldIn, List<Component> tooltip, TooltipFlag tipFlag) {
		tooltip.add(new TranslatableComponent("tips.block_chabudai").withStyle(ChatFormatting.GRAY));
	}
}
