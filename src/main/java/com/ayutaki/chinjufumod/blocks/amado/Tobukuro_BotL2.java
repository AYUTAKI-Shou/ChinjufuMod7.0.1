...
public class Tobukuro_BotL2 extends BaseStage2_Face {
	...
	private Block takeLeftTop2() {
		...
		if (this == Slidedoor_Blocks.TOBUKUROS_BOTL2) { return Slidedoor_Blocks.TOBUKUROS_TOPL2; }
		return null;
	}
	
	private Block takeTop() {
		if (this == Slidedoor_Blocks.TOBUKURO_BOTL2) { return Slidedoor_Blocks.AMADO_TOP; }
		if (this == Slidedoor_Blocks.TOBUKUROS_BOTL2) { return Slidedoor_Blocks.AMADOS_TOP; }
		return null;
	}

	private Block takeBot() {
		if (this == Slidedoor_Blocks.TOBUKURO_BOTL2) { return Slidedoor_Blocks.AMADO_BOT; }
		if (this == Slidedoor_Blocks.TOBUKUROS_BOTL2) { return Slidedoor_Blocks.AMADOS_BOT; }
		return null;
	}
	...
	public List<ItemStack> getDrops(IBlockAccess worldIn, BlockPos pos, IBlockState state, int fortune) {
		...
		if (this == Slidedoor_Blocks.TOBUKURO_BOTL2) { stack.add(new ItemStack(Items_Wadeco.TOBUKURO_BOTR)); }
		if (this == Slidedoor_Blocks.TOBUKUROS_BOTL2) { stack.add(new ItemStack(Items_Wadeco.TOBUKUROS_BOTR)); }
		return stack;
	}

	@Override
	public ItemStack getPickBlock(IBlockState state, RayTraceResult target, World worldIn, BlockPos pos, EntityPlayer playerIn) {
		if (this == Slidedoor_Blocks.TOBUKUROS_BOTL2) { return new ItemStack(Items_Wadeco.TOBUKUROS_BOTR); }
