...
public class Tobukuro extends Base_Tobukuro {
			...
			default:
				...
				default:
					if (worldIn.getBlockState(new BlockPos(x - 1, y, z)).getMaterial().isReplaceable() && 
						...
						worldIn.setBlockState(new BlockPos(x - 1, y, z), AMADO_FACELO.with(Amado.STAGE_1_4, Integer.valueOf(1)));
						worldIn.setBlockState(new BlockPos(x - 1, y + 1, z), AMADO_FACEUP.with(Amado.STAGE_1_4, Integer.valueOf(1))); }
				...
				case EAST:
					if (worldIn.getBlockState(new BlockPos(x, y, z - 1)).getMaterial().isReplaceable() && 
						...
						worldIn.setBlockState(new BlockPos(x, y, z - 1), AMADO_FACELO.with(Amado.STAGE_1_4, Integer.valueOf(1)));
						worldIn.setBlockState(new BlockPos(x, y + 1, z - 1), AMADO_FACEUP.with(Amado.STAGE_1_4, Integer.valueOf(1))); }
			...
			case UPPER:
				...
				default:
					if (worldIn.getBlockState(new BlockPos(x - 1, y, z)).getMaterial().isReplaceable() && 
						...
						worldIn.setBlockState(new BlockPos(x - 1, y, z), AMADO_FACEUP.with(Amado.STAGE_1_4, Integer.valueOf(1)));
						worldIn.setBlockState(new BlockPos(x - 1, y - 1, z), AMADO_FACELO.with(Amado.STAGE_1_4, Integer.valueOf(1))); }
				...
				case EAST:
					if (worldIn.getBlockState(new BlockPos(x, y, z - 1)).getMaterial().isReplaceable() && 
						...
						worldIn.setBlockState(new BlockPos(x, y, z - 1), AMADO_FACEUP.with(Amado.STAGE_1_4, Integer.valueOf(1)));
						worldIn.setBlockState(new BlockPos(x, y - 1, z - 1), AMADO_FACELO.with(Amado.STAGE_1_4, Integer.valueOf(1))); }
	...
	private Block takeBlock() {
		...
		if (this == Slidedoor_Blocks.TOBUKURO_S) { return Slidedoor_Blocks.AMADO_S; }
		return null;
	}
	
	private Block takeLBlock() {
		if (this == Slidedoor_Blocks.TOBUKURO) { return Slidedoor_Blocks.TOBUKURO_L; }
		if (this == Slidedoor_Blocks.TOBUKURO_S) { return Slidedoor_Blocks.TOBUKURO_SL; }
		return null;
	}
