...
public class ShoujiHalf extends BaseStage4_Face {
	...
	private ItemStack takeStack() {
		if (this == Slidedoor_Blocks.SHOUJIH) { return new ItemStack(Items_Wadeco.SHOUJIH_item, 1, 0); }
		if (this == Slidedoor_Blocks.SHOUJIH_SPRU) { return new ItemStack(Items_Wadeco.SHOUJIH_item, 1, 1); }
		if (this == Slidedoor_Blocks.SHOUJIH_BIR) { return new ItemStack(Items_Wadeco.SHOUJIH_item, 1, 2); }
		if (this == Slidedoor_Blocks.SHOUJIH_JUN) { return new ItemStack(Items_Wadeco.SHOUJIH_item, 1, 3); }
		if (this == Slidedoor_Blocks.SHOUJIH_ACA) { return new ItemStack(Items_Wadeco.SHOUJIH_item, 1, 4); }
		if (this == Slidedoor_Blocks.SHOUJIH_DOAK) { return new ItemStack(Items_Wadeco.SHOUJIH_item, 1, 5); }
		
		if (this == Slidedoor_Blocks.SHOUJIH_SAKU) { return new ItemStack(Items_Seasonal.SSHOUJIH_item, 1, 0); }
		if (this == Slidedoor_Blocks.SHOUJIH_KAE) { return new ItemStack(Items_Seasonal.SSHOUJIH_item, 1, 1); }
		if (this == Slidedoor_Blocks.SHOUJIH_ICH) { return new ItemStack(Items_Seasonal.SSHOUJIH_item, 1, 2); }
		return null;
	}
}
