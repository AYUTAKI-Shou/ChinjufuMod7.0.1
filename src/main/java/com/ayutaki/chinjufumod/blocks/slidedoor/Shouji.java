...
public class Shouji extends Block {
	...
	private ItemStack takeStack(IBlockState state) {
		...
		if (state.getValue(HALF) != HalfState.UPPER) {
			if (this == Shouji_Blocks.SHOUJI) { return new ItemStack(Items_Wadeco.SHOUJI_item, 1, 0); }
			if (this == Shouji_Blocks.SHOUJI_SPRU) { return new ItemStack(Items_Wadeco.SHOUJI_item, 1, 1); }
			if (this == Shouji_Blocks.SHOUJI_BIR) { return new ItemStack(Items_Wadeco.SHOUJI_item, 1, 2); }
			if (this == Shouji_Blocks.SHOUJI_JUN) { return new ItemStack(Items_Wadeco.SHOUJI_item, 1, 3); }
			if (this == Shouji_Blocks.SHOUJI_ACA) { return new ItemStack(Items_Wadeco.SHOUJI_item, 1, 4); }
			if (this == Shouji_Blocks.SHOUJI_DOAK) { return new ItemStack(Items_Wadeco.SHOUJI_item, 1, 5); }
			if (this == Shouji_Blocks.SHOUJIB) { return new ItemStack(Items_Wadeco.SHOUJI_item, 1, 6); }
			if (this == Shouji_Blocks.SHOUJIB_SPRU) { return new ItemStack(Items_Wadeco.SHOUJI_item, 1, 7); }
			if (this == Shouji_Blocks.SHOUJIB_BIR) { return new ItemStack(Items_Wadeco.SHOUJI_item, 1, 8); }
			if (this == Shouji_Blocks.SHOUJIB_JUN) { return new ItemStack(Items_Wadeco.SHOUJI_item, 1, 9); }
			if (this == Shouji_Blocks.SHOUJIB_ACA) { return new ItemStack(Items_Wadeco.SHOUJI_item, 1, 10); }
			if (this == Shouji_Blocks.SHOUJIB_DOAK) { return new ItemStack(Items_Wadeco.SHOUJI_item, 1, 11); }
			
			if (this == Shouji_Blocks.SHOUJI_SAKU) { return new ItemStack(Items_Seasonal.SSHOUJI_item, 1, 0); }
			if (this == Shouji_Blocks.SHOUJI_KAE) { return new ItemStack(Items_Seasonal.SSHOUJI_item, 1, 1); }
			if (this == Shouji_Blocks.SHOUJI_ICH) { return new ItemStack(Items_Seasonal.SSHOUJI_item, 1, 2); }
			if (this == Shouji_Blocks.SHOUJIB_SAKU) { return new ItemStack(Items_Seasonal.SSHOUJI_item, 1, 3); }
			if (this == Shouji_Blocks.SHOUJIB_KAE) { return new ItemStack(Items_Seasonal.SSHOUJI_item, 1, 4); }
			if (this == Shouji_Blocks.SHOUJIB_ICH) { return new ItemStack(Items_Seasonal.SSHOUJI_item, 1, 5); }
		}
		return null;
	}
