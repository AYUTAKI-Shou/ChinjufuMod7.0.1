...
public class GlassDoor extends Block {
	...
	private ItemStack takeStack(IBlockState state) {
		...
		if (state.getValue(HALF) != HalfState.UPPER) {
			if (this == Garasudo_Blocks.GARASUDO) { return new ItemStack(Items_Wadeco.GARASUDO_item, 1, 0); }
			if (this == Garasudo_Blocks.GARASUDO_SPRU) { return new ItemStack(Items_Wadeco.GARASUDO_item, 1, 1); }
			if (this == Garasudo_Blocks.GARASUDO_BIR) { return new ItemStack(Items_Wadeco.GARASUDO_item, 1, 2); }
			if (this == Garasudo_Blocks.GARASUDO_JUN) { return new ItemStack(Items_Wadeco.GARASUDO_item, 1, 3); }
			if (this == Garasudo_Blocks.GARASUDO_ACA) { return new ItemStack(Items_Wadeco.GARASUDO_item, 1, 4); }
			if (this == Garasudo_Blocks.GARASUDO_DOAK) { return new ItemStack(Items_Wadeco.GARASUDO_item, 1, 5); }
			if (this == Garasudo_Blocks.GARASUDOB) { return new ItemStack(Items_Wadeco.GARASUDO_item, 1, 6); }
			if (this == Garasudo_Blocks.GARASUDOB_SPRU) { return new ItemStack(Items_Wadeco.GARASUDO_item, 1, 7); }
			if (this == Garasudo_Blocks.GARASUDOB_BIR) { return new ItemStack(Items_Wadeco.GARASUDO_item, 1, 8); }
			if (this == Garasudo_Blocks.GARASUDOB_JUN) { return new ItemStack(Items_Wadeco.GARASUDO_item, 1, 9); }
			if (this == Garasudo_Blocks.GARASUDOB_ACA) { return new ItemStack(Items_Wadeco.GARASUDO_item, 1, 10); }
			if (this == Garasudo_Blocks.GARASUDOB_DOAK) { return new ItemStack(Items_Wadeco.GARASUDO_item, 1, 11); }
			
			if (this == Garasudo_Blocks.GARASUDO_SAKU) { return new ItemStack(Items_Seasonal.SGARASUDO_item, 1, 0); }
			if (this == Garasudo_Blocks.GARASUDO_KAE) { return new ItemStack(Items_Seasonal.SGARASUDO_item, 1, 1); }
			if (this == Garasudo_Blocks.GARASUDO_ICH) { return new ItemStack(Items_Seasonal.SGARASUDO_item, 1, 2); }
			if (this == Garasudo_Blocks.GARASUDOB_SAKU) { return new ItemStack(Items_Seasonal.SGARASUDO_item, 1, 3); }
			if (this == Garasudo_Blocks.GARASUDOB_KAE) { return new ItemStack(Items_Seasonal.SGARASUDO_item, 1, 4); }
			if (this == Garasudo_Blocks.GARASUDOB_ICH) { return new ItemStack(Items_Seasonal.SGARASUDO_item, 1, 5); }
		}
		return null;
	}
