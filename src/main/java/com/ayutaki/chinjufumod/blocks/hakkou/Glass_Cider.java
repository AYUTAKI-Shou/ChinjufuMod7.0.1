...
public class Glass_Cider extends Base_Glass {
	...
	private void take1(PlayerEntity playerIn) {
		if (this == Hakkou_Blocks.CIDERGLASS) { 
		...
		if (this == Hakkou_Blocks.JUKUCIDERGLASS) { 
	...
	private ItemStack takeStack() {
		if (this == Hakkou_Blocks.CIDERGLASS) { return new ItemStack(Items_Teatime.CIDERGLASS, 1); }
		if (this == Hakkou_Blocks.JUKUCIDERGLASS) { return new ItemStack(Items_Teatime.JUKUCIDERGLASS, 1); }
		return null;
	}
}
