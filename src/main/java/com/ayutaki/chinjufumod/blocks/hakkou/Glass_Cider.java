...
public class Glass_Cider extends Base_Glass {
	...
	public Glass_Cider(BlockBehaviour.Properties properties) {
		super(properties);
	}
	...
	private void take1(Player playerIn) {
		if (this == Hakkou_Blocks.CIDERGLASS.get()) { 
		...
		if (this == Hakkou_Blocks.JUKUCIDERGLASS.get()) { 
	...
	private ItemStack takeStack() {
		if (this == Hakkou_Blocks.CIDERGLASS.get()) { return new ItemStack(Items_Teatime.CIDERGLASS.get(), 1); }
		if (this == Hakkou_Blocks.JUKUCIDERGLASS.get()) { return new ItemStack(Items_Teatime.JUKUCIDERGLASS.get(), 1); }
		return null;
	}
}
