...
public class Glass_Wine extends Base_Glass {
	...
	private void take1(PlayerEntity playerIn) {
		if (this == Hakkou_Blocks.WINEGLASS) { 
		...
		if (this == Hakkou_Blocks.JUKUWINEGLASS) { 
	...
	private ItemStack takeStack() {
		if (this == Hakkou_Blocks.WINEGLASS) { return new ItemStack(Items_Teatime.WINEGLASS, 1); }
		if (this == Hakkou_Blocks.JUKUWINEGLASS) { return new ItemStack(Items_Teatime.JUKUWINEGLASS, 1); }
		return null;
	}
}
