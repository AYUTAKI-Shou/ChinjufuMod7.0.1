...
public class Glass_Wine extends Base_Glass {
	...
	public Glass_Wine(BlockBehaviour.Properties properties) {
		super(properties);
	}
	...
	private void take1(Player playerIn) {
		if (this == Hakkou_Blocks.WINEGLASS.get()) { 
		...
		if (this == Hakkou_Blocks.JUKUWINEGLASS.get()) { 
	...
	private ItemStack takeStack() {
		if (this == Hakkou_Blocks.WINEGLASS.get()) { return new ItemStack(Items_Teatime.WINEGLASS.get(), 1); }
		if (this == Hakkou_Blocks.JUKUWINEGLASS.get()) { return new ItemStack(Items_Teatime.JUKUWINEGLASS.get(), 1); }
		return null;
	}
}
