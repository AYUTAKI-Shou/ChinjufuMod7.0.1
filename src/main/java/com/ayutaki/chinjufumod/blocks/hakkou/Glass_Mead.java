...
public class Glass_Mead extends Base_Glass {
	...
	public Glass_Mead(BlockBehaviour.Properties properties) {
		super(properties);
	}
	...
	private void take1(Player playerIn) {
		if (this == Hakkou_Blocks.MEADGLASS.get()) { 
		...
		if (this == Hakkou_Blocks.JUKUMEADGLASS.get()) { 
			playerIn.removeEffect(MobEffects.POISON);
	...
	private ItemStack takeStack() {
		if (this == Hakkou_Blocks.MEADGLASS.get()) { return new ItemStack(Items_Teatime.MEADGLASS.get(), 1); }
		if (this == Hakkou_Blocks.JUKUMEADGLASS.get()) { return new ItemStack(Items_Teatime.JUKUMEADGLASS.get(), 1); }
		return null;
	}
}
