...
public class Tana_Nori extends BaseTana_Stage05 {
	...
	public Tana_Nori(BlockBehaviour.Properties properties) {
		super(properties);
	}
	...
	public InteractionResult use(BlockState state, Level worldIn, BlockPos pos, Player playerIn, InteractionHand hand, BlockHitResult hit) {
		...
		if (i == 5) {
			...
			if (stack.isEmpty()) {
				...
				playerIn.getInventory().add(new ItemStack(Items_Teatime.NORI_I.get(), 4));
	...
	public void appendHoverText(ItemStack stack, @Nullable BlockGetter worldIn, List<Component> tooltip, TooltipFlag tipFlag) {
		tooltip.add(new TranslatableComponent("tips.block_taru_nori").withStyle(ChatFormatting.GRAY));
	}
}
