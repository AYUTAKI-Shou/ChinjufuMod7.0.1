...
public class SnowMan_Top5 extends Base_SnowManTop {
	...
	public SnowMan_Top5(String name) {
		super(name);
	}
	...
	private ItemStack takeWool(IBlockState state) {
		...
		if (i == 1) { return new ItemStack(Item.getItemFromBlock(Blocks.WOOL), 1, 12); }
		if (i == 2) { return new ItemStack(Item.getItemFromBlock(Blocks.WOOL), 1, 13); }
		if (i == 3) { return new ItemStack(Item.getItemFromBlock(Blocks.WOOL), 1, 14); }
		if (i == 4) { return new ItemStack(Item.getItemFromBlock(Blocks.WOOL), 1, 15); }
		return null;
	}
}
