...
public class SnowMan_Top3 extends Base_SnowManTop {
	...
	public SnowMan_Top3(String name) {
		super(name);
	}
	...
	private ItemStack takeWool(IBlockState state) {
		...
		if (i == 1) { return new ItemStack(Item.getItemFromBlock(Blocks.WOOL), 1, 4); }
		if (i == 2) { return new ItemStack(Item.getItemFromBlock(Blocks.WOOL), 1, 5); }
		if (i == 3) { return new ItemStack(Item.getItemFromBlock(Blocks.WOOL), 1, 6); }
		if (i == 4) { return new ItemStack(Item.getItemFromBlock(Blocks.WOOL), 1, 7); }
		return null;
	}
}
