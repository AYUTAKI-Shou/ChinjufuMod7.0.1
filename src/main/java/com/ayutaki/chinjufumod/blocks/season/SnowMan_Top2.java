...
public class SnowMan_Top2 extends Base_SnowManTop {
	...
	public SnowMan_Top2(String name) {
		super(name);
	}
	...
	private ItemStack takeWool(IBlockState state) {
		...
		if (i == 1) { return new ItemStack(Item.getItemFromBlock(Blocks.WOOL), 1, 0); }
		if (i == 2) { return new ItemStack(Item.getItemFromBlock(Blocks.WOOL), 1, 1); }
		if (i == 3) { return new ItemStack(Item.getItemFromBlock(Blocks.WOOL), 1, 2); }
		if (i == 4) { return new ItemStack(Item.getItemFromBlock(Blocks.WOOL), 1, 3); }
		return null;
	}
}
