...
import com.ayutaki.chinjufumod.blocks.base.BaseSlab_Water;
...
public class WoodSlab_CM extends BaseSlab_Water {

	public WoodSlab_CM(BlockBehaviour.Properties properties) {
		super(properties);
	}
