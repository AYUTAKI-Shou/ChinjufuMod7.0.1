...
public class Kamoi_Birch extends Base_Kamoi {
	...
	public Kamoi_Birch(BlockBehaviour.Properties properties) {
		super(properties);
	}
		...
		if (!playerIn.isCrouching()) {
			...
			if (wood) {
				if (item == Items.OAK_SLAB) {
					...
					worldIn.setBlock(pos, KamoiPlanks_Blocks.KAMOI_oak_bir.get().defaultBlockState()
							.setValue(H_FACING, state.getValue(H_FACING))
							.setValue(STAGE_1_4, state.getValue(STAGE_1_4)), 3);
				...
				if (item == Items.SPRUCE_SLAB) {
					...
					worldIn.setBlock(pos, KamoiPlanks_Blocks.KAMOI_spru_bir.get().defaultBlockState()
							.setValue(H_FACING, state.getValue(H_FACING))
							.setValue(STAGE_1_4, state.getValue(STAGE_1_4)), 3);
				...
				if (item == Items.BIRCH_SLAB) {
					...
					worldIn.setBlock(pos, KamoiPlanks_Blocks.KAMOI_bir_bir.get().defaultBlockState()
							.setValue(H_FACING, state.getValue(H_FACING))
							.setValue(STAGE_1_4, state.getValue(STAGE_1_4)), 3);
				...
				if (item == Items.JUNGLE_SLAB) {
					...
					worldIn.setBlock(pos, KamoiPlanks_Blocks.KAMOI_jun_bir.get().defaultBlockState()
							.setValue(H_FACING, state.getValue(H_FACING))
							.setValue(STAGE_1_4, state.getValue(STAGE_1_4)), 3);
				...
				if (item == Items.ACACIA_SLAB) {
					...
					worldIn.setBlock(pos, KamoiPlanks_Blocks.KAMOI_aca_bir.get().defaultBlockState()
							.setValue(H_FACING, state.getValue(H_FACING))
							.setValue(STAGE_1_4, state.getValue(STAGE_1_4)), 3);
				...
				if (item == Items.DARK_OAK_SLAB) {
					...
					worldIn.setBlock(pos, KamoiPlanks_Blocks.KAMOI_doak_bir.get().defaultBlockState()
							.setValue(H_FACING, state.getValue(H_FACING))
							.setValue(STAGE_1_4, state.getValue(STAGE_1_4)), 3);
				...
				if (item == Items_Seasonal.SAKURA_slabhalf.get()) {
					...
					worldIn.setBlock(pos, KamoiPlanks_Blocks.KAMOI_saku_bir.get().defaultBlockState()
							.setValue(H_FACING, state.getValue(H_FACING))
							.setValue(STAGE_1_4, state.getValue(STAGE_1_4)), 3);
				...
				if (item == Items_Seasonal.KAEDE_slabhalf.get()) {
					...
					worldIn.setBlock(pos, KamoiPlanks_Blocks.KAMOI_kae_bir.get().defaultBlockState()
							.setValue(H_FACING, state.getValue(H_FACING))
							.setValue(STAGE_1_4, state.getValue(STAGE_1_4)), 3);
				...
				if (item == Items_Seasonal.ICHOH_slabhalf.get()) {
					...
					worldIn.setBlock(pos, KamoiPlanks_Blocks.KAMOI_ich_bir.get().defaultBlockState()
							.setValue(H_FACING, state.getValue(H_FACING))
							.setValue(STAGE_1_4, state.getValue(STAGE_1_4)), 3);
