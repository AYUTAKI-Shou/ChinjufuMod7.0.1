...
public class Kamoi_Spruce extends Base_Kamoi {
	...
	public Kamoi_Spruce(BlockBehaviour.Properties properties) {
		super(properties);
	}
		...
		if (!playerIn.isCrouching()) {
			...
			if (wood) {
				if (item == Items.OAK_SLAB) {
					...
					worldIn.setBlock(pos, KamoiPlanks_Blocks.KAMOI_oak_spru.get().defaultBlockState()
							.setValue(H_FACING, state.getValue(H_FACING))
							.setValue(STAGE_1_4, state.getValue(STAGE_1_4)), 3);
				...
				if (item == Items.SPRUCE_SLAB) {
					...
					worldIn.setBlock(pos, KamoiPlanks_Blocks.KAMOI_spru_spru.get().defaultBlockState()
							.setValue(H_FACING, state.getValue(H_FACING))
							.setValue(STAGE_1_4, state.getValue(STAGE_1_4)), 3);
				...
				if (item == Items.BIRCH_SLAB) {
					...
					worldIn.setBlock(pos, KamoiPlanks_Blocks.KAMOI_bir_spru.get().defaultBlockState()
							.setValue(H_FACING, state.getValue(H_FACING))
							.setValue(STAGE_1_4, state.getValue(STAGE_1_4)), 3);
				...
				if (item == Items.JUNGLE_SLAB) {
					...
					worldIn.setBlock(pos, KamoiPlanks_Blocks.KAMOI_jun_spru.get().defaultBlockState()
							.setValue(H_FACING, state.getValue(H_FACING))
							.setValue(STAGE_1_4, state.getValue(STAGE_1_4)), 3);
				...
				if (item == Items.ACACIA_SLAB) {
					...
					worldIn.setBlock(pos, KamoiPlanks_Blocks.KAMOI_aca_spru.get().defaultBlockState()
							.setValue(H_FACING, state.getValue(H_FACING))
							.setValue(STAGE_1_4, state.getValue(STAGE_1_4)), 3);
				...
				if (item == Items.DARK_OAK_SLAB) {
					...
					worldIn.setBlock(pos, KamoiPlanks_Blocks.KAMOI_doak_spru.get().defaultBlockState()
							.setValue(H_FACING, state.getValue(H_FACING))
							.setValue(STAGE_1_4, state.getValue(STAGE_1_4)), 3);
				...
				if (item == Items_Seasonal.SAKURA_slabhalf.get()) {
					...
					worldIn.setBlock(pos, KamoiPlanks_Blocks.KAMOI_saku_spru.get().defaultBlockState()
							.setValue(H_FACING, state.getValue(H_FACING))
							.setValue(STAGE_1_4, state.getValue(STAGE_1_4)), 3);
				...
				if (item == Items_Seasonal.KAEDE_slabhalf.get()) {
					...
					worldIn.setBlock(pos, KamoiPlanks_Blocks.KAMOI_kae_spru.get().defaultBlockState()
							.setValue(H_FACING, state.getValue(H_FACING))
							.setValue(STAGE_1_4, state.getValue(STAGE_1_4)), 3);
				...
				if (item == Items_Seasonal.ICHOH_slabhalf.get()) {
					...
					worldIn.setBlock(pos, KamoiPlanks_Blocks.KAMOI_ich_spru.get().defaultBlockState()
							.setValue(H_FACING, state.getValue(H_FACING))
							.setValue(STAGE_1_4, state.getValue(STAGE_1_4)), 3);
