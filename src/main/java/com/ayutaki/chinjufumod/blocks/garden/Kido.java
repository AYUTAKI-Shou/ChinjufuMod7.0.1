...
public class Kido extends CM_WaterLogged {
	...
	protected static final VoxelShape FRAME_SOUTH = Block.makeCuboidShape(0.0D, 0.0D, 6.75D, 16.0D, 0.01D, 9.25D);
	protected static final VoxelShape FRAME_WEST = Block.makeCuboidShape(6.75D, 0.0D, 0.0D, 9.25D, 0.01D, 16.0D);
	protected static final VoxelShape FRAME_NORTH = Block.makeCuboidShape(0.0D, 0.0D, 6.75D, 16.0D, 0.01D, 9.25D);
	protected static final VoxelShape FRAME_EAST = Block.makeCuboidShape(6.75D, 0.0D, 0.0D, 9.25D, 0.01D, 16.0D);

	protected static final VoxelShape CLOSE_SOUTH = Block.makeCuboidShape(0.0D, 0.0D, 6.75D, 16.0D, 16.0D, 9.25D);
	protected static final VoxelShape CLOSE_WEST = Block.makeCuboidShape(6.75D, 0.0D, 0.0D, 9.25D, 16.0D, 16.0D);
	protected static final VoxelShape CLOSE_NORTH = Block.makeCuboidShape(0.0D, 0.0D, 6.75D, 16.0D, 16.0D, 9.25D);
	protected static final VoxelShape CLOSE_EAST = Block.makeCuboidShape(6.75D, 0.0D, 0.0D, 9.25D, 16.0D, 16.0D);

	protected static final VoxelShape OPENBR_SOUTH = VoxelShapes.or(FRAME_SOUTH, Block.makeCuboidShape(13.5D, 0.0D, 6.75D, 16.0D, 16.0D, 22.75D));
	protected static final VoxelShape OPENBR_WEST = VoxelShapes.or(FRAME_WEST, Block.makeCuboidShape(-6.75D, 0.0D, 13.5D, 9.25D, 16.0D, 16.0D));
	protected static final VoxelShape OPENBR_NORTH = VoxelShapes.or(FRAME_NORTH, Block.makeCuboidShape(0.0D, 0.0D, -6.75D, 2.5D, 16.0D, 9.25D));
	protected static final VoxelShape OPENBR_EAST = VoxelShapes.or(FRAME_EAST, Block.makeCuboidShape(6.75D, 0.0D, 0.0D, 22.75D, 16.0D, 2.5D));

	protected static final VoxelShape OPENBL_SOUTH = VoxelShapes.or(FRAME_SOUTH, Block.makeCuboidShape(0.0D, 0.0D, 6.75D, 2.5D, 16.0D, 22.75D));
	protected static final VoxelShape OPENBL_WEST = VoxelShapes.or(FRAME_WEST, Block.makeCuboidShape(-6.75D, 0.0D, 0.0D, 9.25D, 16.0D, 2.5D));
	protected static final VoxelShape OPENBL_NORTH = VoxelShapes.or(FRAME_NORTH, Block.makeCuboidShape(13.5D, 0.0D, -6.75D, 16.0D, 16.0D, 9.25D));
	protected static final VoxelShape OPENBL_EAST = VoxelShapes.or(FRAME_EAST, Block.makeCuboidShape(6.75D, 0.0D, 13.5D, 22.75D, 16.0D, 16.0D));

	protected static final VoxelShape OPENR_SOUTH = Block.makeCuboidShape(13.5D, 0.0D, 6.75D, 16.0D, 16.0D, 22.75D);
	protected static final VoxelShape OPENR_WEST = Block.makeCuboidShape(-6.75D, 0.0D, 13.5D, 9.25D, 16.0D, 16.0D);
	protected static final VoxelShape OPENR_NORTH = Block.makeCuboidShape(0.0D, 0.0D, -6.75D, 2.5D, 16.0D, 9.25D);
	protected static final VoxelShape OPENR_EAST = Block.makeCuboidShape(6.75D, 0.0D, 0.0D, 22.75D, 16.0D, 2.5D);

	protected static final VoxelShape OPENL_SOUTH = Block.makeCuboidShape(0.0D, 0.0D, 6.75D, 2.5D, 16.0D, 22.75D);
	protected static final VoxelShape OPENL_WEST = Block.makeCuboidShape(-6.75D, 0.0D, 0.0D, 9.25D, 16.0D, 2.5D);
	protected static final VoxelShape OPENL_NORTH = Block.makeCuboidShape(13.5D, 0.0D, -6.75D, 16.0D, 16.0D, 9.25D);
	protected static final VoxelShape OPENL_EAST = Block.makeCuboidShape(6.75D, 0.0D, 13.5D, 22.75D, 16.0D, 16.0D);

	public Kido(Block.Properties properties) {
		super(properties);
		/** Default state **/
	...
	private void moveSound(World worldIn, BlockPos pos, boolean isOpening) {
		if (isOpening == true) { worldIn.playSound(null, pos, SoundEvents.BLOCK_WOODEN_DOOR_CLOSE, SoundCategory.BLOCKS, 0.8F, 1.0F); }
		if (isOpening != true) { worldIn.playSound(null, pos, SoundEvents.BLOCK_WOODEN_DOOR_OPEN, SoundCategory.BLOCKS, 0.8F, 1.0F); }
	}
