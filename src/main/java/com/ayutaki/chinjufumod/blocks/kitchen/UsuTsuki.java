...
public class UsuTsuki extends CM_WaterLogged {
	...
	/* Collision */
	protected static final VoxelShape AABB_0 = Block.makeCuboidShape(1.0D, 0.0D, 1.0D, 15.0D, 14.0D, 15.0D);
	protected static final VoxelShape AABB_1 = Block.makeCuboidShape(2.0D, 0.0D, 2.0D, 14.0D, 12.0D, 14.0D);

	public UsuTsuki(Block.Properties properties) {
		super(properties);
