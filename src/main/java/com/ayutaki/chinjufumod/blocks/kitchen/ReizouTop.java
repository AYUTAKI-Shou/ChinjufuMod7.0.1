...
public class ReizouTop extends BlockContainer {
	...
	protected static final AxisAlignedBB AABB_SOUTH = CollisionHelper.getBlockBounds(EnumFacing.SOUTH, 0.0, 0.0, 0.0, 0.8375, 0.625, 1.0);
	protected static final AxisAlignedBB AABB_EAST = CollisionHelper.getBlockBounds(EnumFacing.EAST, 0.0, 0.0, 0.0, 0.8375, 0.625, 1.0);
	protected static final AxisAlignedBB AABB_WEST = CollisionHelper.getBlockBounds(EnumFacing.WEST, 0.0, 0.0, 0.0, 0.8375, 0.625, 1.0);
	protected static final AxisAlignedBB AABB_NORTH = CollisionHelper.getBlockBounds(EnumFacing.NORTH, 0.0, 0.0, 0.0, 0.8375, 0.625, 1.0);
	...
	public boolean onBlockActivated(World worldIn, BlockPos pos, IBlockState state, EntityPlayer playerIn,
		...
		default:
			...
			if (northState.getMaterial().isReplaceable()) {
				...
				if (!(northState.getBlock() instanceof BlockStaticLiquid) && !(northState.getBlock() instanceof BlockDynamicLiquid)) {
					if (tile instanceof ReizouTop_TileEntity) { playerIn.displayGUIChest((IInventory) tile); }
				} }
			break;
