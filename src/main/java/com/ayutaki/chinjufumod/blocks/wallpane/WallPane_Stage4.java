...
public class WallPane_Stage4 extends BaseStage4_FaceWater {
	...
	public WallPane_Stage4(BlockBehaviour.Properties properties) {
		super(properties);
	}
	...
	public InteractionResult use(BlockState state, Level worldIn, BlockPos pos, Player playerIn, InteractionHand hand, BlockHitResult hit) {
		...
		if (stack.isEmpty()) {
			...
			if (playerIn.isCrouching()) {
				if (this == WallPanel_Blocks.WP_STONE_B.get() || this == WallPanel_Blocks.WP_STONE_graB.get() || this == WallPanel_Blocks.
						WP_STONE_dioB.get()|| this == WallPanel_Blocks.WP_STONE_andB.get()) {
	...
	public void appendHoverText(ItemStack stack, @Nullable BlockGetter worldIn, List<Component> tooltip, TooltipFlag tipFlag) {
		tooltip.add(new TranslatableComponent("tips.wp_stage4").withStyle(ChatFormatting.GRAY));
	}
}
