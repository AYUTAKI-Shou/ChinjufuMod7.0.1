...
public class WakeWater1 extends Base_WakeWater {
	...
	public BlockState updatePostPlacement(BlockState state, Direction facing, BlockState facingState, IWorld worldIn, BlockPos pos, BlockPos facingPos) {
		if (true) { worldIn.getPendingBlockTicks().scheduleTick(pos, ChinjufuMod_Blocks.WAKE_WATER1, 10); }
	...
	public void onBlockAdded(BlockState state, World worldIn, BlockPos pos, BlockState oldState, boolean isMoving) {
		worldIn.getPendingBlockTicks().scheduleTick(pos, ChinjufuMod_Blocks.WAKE_WATER1, 10);
	}
	...
	public void tick(BlockState state, ServerWorld worldIn, BlockPos pos, Random rand) {
		...
		worldIn.getPendingBlockTicks().scheduleTick(pos, ChinjufuMod_Blocks.WAKE_WATER1, 10);
		worldIn.setBlockState(pos, ChinjufuMod_Blocks.WAKE_WATER2.getDefaultState());
	}
