...
public class Base_WakeWater extends Block implements IBucketPickupHandler {
	...
	public Base_WakeWater(Block.Properties properties) {
		super(properties);
	}
	...
	public ActionResultType onBlockActivated(BlockState state, World worldIn, BlockPos pos, PlayerEntity playerIn, Hand hand, BlockRayTraceResult hit) {
		...
		if (item == Items_Teatime.NABE_kara) {
			...
			if (stack.isEmpty()) { playerIn.inventory.addItemStackToInventory(new ItemStack(Items_Teatime.NABESHIO_nama)); }
