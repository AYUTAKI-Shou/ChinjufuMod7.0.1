...
public class Zundou4_Pasta extends BaseStage4_Face {
	...
	public boolean onBlockActivated(World worldIn, BlockPos pos, IBlockState state, EntityPlayer playerIn,
		...
		if (item != Items_Teatime.Item_SARA && item != Items_Teatime.PASTA && k != 1) { CMEvents.textNotHave(worldIn, pos, playerIn); }
