...
public class SushiOkeFull_1 extends BaseFood_Stage9Water {
	...
	protected static final VoxelShape AABB9_BOX = Block.makeCuboidShape(1.0D, 0.0D, 1.0D, 15.0D, 2.5D, 15.0D);
	protected static final VoxelShape AABB9_DOWN = Block.makeCuboidShape(1.0D, -8.0D, 1.0D, 15.0D, 0.1D, 15.0D);
