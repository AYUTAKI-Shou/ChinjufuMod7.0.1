...
public class Frypan_OSauce extends BaseStage4_Face {

	protected static final int COOK_TIME = 1000;
	/**1=お好み焼きソース生, 2=お好み焼きソース, 3=カレールー生, 4=カレールー**/
	...
	public boolean onBlockActivated(World worldIn, BlockPos pos, IBlockState state, EntityPlayer playerIn,
		...
		if (i == 2) {
			if (item == Items.GLASS_BOTTLE) {
				...
				if (stack.isEmpty()) {
					playerIn.inventory.addItemStackToInventory(new ItemStack(Items_Teatime.OSAUCE_bot_1)); }
				else if (!playerIn.inventory.addItemStackToInventory(new ItemStack(Items_Teatime.OSAUCE_bot_1))) {
					playerIn.dropItem(new ItemStack(Items_Teatime.OSAUCE_bot_1), false); }
