...
public class Chauke_Senbei extends Base_Chauke {
	...
	public Chauke_Senbei(BlockBehaviour.Properties properties) {
		super(properties);
	}
	...
	public InteractionResult use(BlockState state, Level worldIn, BlockPos pos, Player playerIn, InteractionHand hand, BlockHitResult hit) {
		...
		if (i != 5) {
			...
			if (stack.isEmpty()) {
				...
				playerIn.getInventory().add(new ItemStack(Items_Teatime.SENBEI.get()));
	...
	public ItemStack getCloneItemStack(BlockGetter worldIn, BlockPos pos, BlockState state) {
		return new ItemStack(Items_Teatime.CHAUKE_SENBEI.get());
	}
}
