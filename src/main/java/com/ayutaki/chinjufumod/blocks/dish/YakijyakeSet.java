...
public class YakijyakeSet extends BaseStage4_FaceDown {
	...
	public YakijyakeSet(String name) {
		super(name);
	...
	private ItemStack takeStack() {
		if (this == Dish_Blocks.YAKIJYAKETEI) { return new ItemStack(Items_Teatime.YAKIJYAKETEI, 1, 0); }
		if (this == Dish_Blocks.YAKIJYAKETEI_TAKE) { return new ItemStack(Items_Teatime.YAKIJYAKETEI_TAKE, 1, 0); }
		if (this == Dish_Blocks.YAKIJYAKETEI_KURI) { return new ItemStack(Items_Teatime.YAKIJYAKETEI_KURI, 1, 0); }
		return null;
	}
}
