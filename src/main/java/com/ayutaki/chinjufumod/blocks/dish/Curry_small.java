...
public class Curry_small extends BaseStage4_FaceDown {
	...
	public Curry_small(String name) {
		super(name);
		...
		if (i != 4) {
			...
			if (stack.isEmpty()) {
				...
				if (this == Dish_Blocks.CURRY_T) {
					if (i == 1) {
						/** -600 **/
						((EntityLivingBase) playerIn).addPotionEffect(new PotionEffect(MobEffects.HASTE, 3300, 0));
				...
				if (this != Dish_Blocks.CURRY_T) {
					if (i == 1) {
						...
						((EntityLivingBase) playerIn).addPotionEffect(new PotionEffect(MobEffects.HASTE, 3900, 0));
						((EntityLivingBase) playerIn).addPotionEffect(new PotionEffect(MobEffects.SATURATION, 4, 0)); }
	...
	private ItemStack takeStack() {
		if (this == Dish_Blocks.CURRY) { return new ItemStack(Items_Teatime.CURRY, 1, 0); }
		if (this == Dish_Blocks.CURRY_C) { return new ItemStack(Items_Teatime.CURRY, 1, 1); }
		if (this == Dish_Blocks.CURRY_T) { return new ItemStack(Items_Teatime.CURRY, 1, 2); }
		return null;
	}
}
