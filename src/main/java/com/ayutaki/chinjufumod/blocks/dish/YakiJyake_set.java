...
public class YakiJyake_set extends BaseFood_Stage5Water {
	...
	public ActionResultType use(BlockState state, World worldIn, BlockPos pos, PlayerEntity playerIn, Hand hand, BlockRayTraceResult hit) {
		...
		if (i != 5) {
			...
			if (stack.isEmpty()) {
				...
				if (this == Dish_Blocks.YAKIJYAKETEI) { 
					if (i == 1) {
				...
				if (this != Dish_Blocks.YAKIJYAKETEI) { 
					if (i == 1) {
						/** +100 **/
						playerIn.addEffect(new EffectInstance(Effects.DIG_SPEED, 6300, 0));
						playerIn.addEffect(new EffectInstance(Effects.SATURATION, 4, 0)); }
					...
					if (i == 3) {
						...
						playerIn.addEffect(new EffectInstance(Effects.HEAL, 0, 0));
						playerIn.addEffect(new EffectInstance(Effects.SATURATION, 4, 0));
						playerIn.addEffect(new EffectInstance(Effects.REGENERATION, 3900, 0)); }
		
					if (i == 4) {
						/** +100 **/
						playerIn.addEffect(new EffectInstance(Effects.HEAL, 0, 0));
						playerIn.addEffect(new EffectInstance(Effects.SATURATION, 4, 0));
						playerIn.addEffect(new EffectInstance(Effects.DAMAGE_RESISTANCE, 3900, 1)); }
				}
	...
	private ItemStack takeStack() {
		if (this == Dish_Blocks.YAKIJYAKETEI) { return new ItemStack(Items_Teatime.YAKIJYAKETEI, 1); }
		if (this == Dish_Blocks.YAKIJYAKETEI_TAKE) { return new ItemStack(Items_Teatime.YAKIJYAKETEI_TAKE, 1); }
		if (this == Dish_Blocks.YAKIJYAKETEI_KURI) { return new ItemStack(Items_Teatime.YAKIJYAKETEI_KURI, 1); }
		return null;
	}
}
