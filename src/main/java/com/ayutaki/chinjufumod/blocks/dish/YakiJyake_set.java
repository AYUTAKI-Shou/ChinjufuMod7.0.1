...
public class YakiJyake_set extends BaseFood_Stage5Water {
	...
	public YakiJyake_set(BlockBehaviour.Properties properties) {
		super(properties);
	}
	...
	public InteractionResult use(BlockState state, Level worldIn, BlockPos pos, Player playerIn, InteractionHand hand, BlockHitResult hit) {
		...
		if (i != 5) {
			...
			if (stack.isEmpty()) {
				...
				if (this == Dish_Blocks.YAKIJYAKETEI.get()) { 
					if (i == 1) {
	...
	private ItemStack takeStack() {
		if (this == Dish_Blocks.YAKIJYAKETEI.get()) { return new ItemStack(Items_Teatime.YAKIJYAKETEI.get(), 1); }
		if (this == Dish_Blocks.YAKIJYAKETEI_TAKE.get()) { return new ItemStack(Items_Teatime.YAKIJYAKETEI_TAKE.get(), 1); }
		if (this == Dish_Blocks.YAKIJYAKETEI_KURI.get()) { return new ItemStack(Items_Teatime.YAKIJYAKETEI_KURI.get(), 1); }
		return null;
	}
}
