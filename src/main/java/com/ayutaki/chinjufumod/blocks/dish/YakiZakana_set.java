...
public class YakiZakana_set extends BaseFood_Stage5Water {
	...
	private ItemStack takeStack() {
		if (this == Dish_Blocks.YAKIZAKANATEI) { return new ItemStack(Items_Teatime.YAKIZAKANATEI, 1); }
		if (this == Dish_Blocks.YAKIZAKANATEI_TAKE) { return new ItemStack(Items_Teatime.YAKIZAKANATEI_TAKE, 1); }
		if (this == Dish_Blocks.YAKIZAKANATEI_KURI) { return new ItemStack(Items_Teatime.YAKIZAKANATEI_KURI, 1); }
		return null;
	}
}
