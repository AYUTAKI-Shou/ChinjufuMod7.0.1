...
public class Frypan_PastaNama extends BaseFrypan_2Cook {
	...
	public Frypan_PastaNama(BlockBehaviour.Properties properties) {
		super(properties);
	}
	...
	public InteractionResult use(BlockState state, Level worldIn, BlockPos pos, Player playerIn, InteractionHand hand, BlockHitResult hit) {
		...
		if (i != 1) {
			if (item == Items_Teatime.PASTA_sara.get()) {
			...
			if (item != Items_Teatime.PASTA_sara.get()) { CMEvents.textNotHave(worldIn, pos, playerIn); }
		}
	...
	private ItemStack takeStack() {
		if (this == Dish_Blocks.FPTOMATO_nama.get()) { return new ItemStack(Items_Teatime.PASTATOMATO.get(), 1); }
		if (this == Dish_Blocks.FPKINOKO_nama.get()) { return new ItemStack(Items_Teatime.PASTAKINOKO.get(), 1); }
		if (this == Dish_Blocks.FPSEAFOOD_nama.get()) { return new ItemStack(Items_Teatime.PASTASEAFOOD.get(), 1); }
		return null;
	}
	...
	public void appendHoverText(ItemStack stack, @Nullable BlockGetter worldIn, List<Component> tooltip, TooltipFlag tipFlag) {
		...
		tooltip.add(new TranslatableComponent("tips.block_food_frypan_pasta").withStyle(ChatFormatting.GRAY));
	}
}
