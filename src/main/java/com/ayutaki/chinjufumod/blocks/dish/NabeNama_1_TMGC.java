...
public class NabeNama_1_TMGC extends BaseStage4_Face {
	...
	public NabeNama_1_TMGC(String name) {
		super(name);
	...
	public void updateTick(World worldIn, BlockPos pos, IBlockState state, Random rand) {
		...
		if (this.isCooking(worldIn, pos)) {
			worldIn.scheduleUpdate(pos, this, this.tickRate(worldIn));
			worldIn.setBlockState(pos, this.takeBlock(state).getDefaultState()
	...
	private Block takeBlock(IBlockState state) {
		...
		if (i == 4) { return Dish_Blocks.NABECORNSOUP; }
		return null;
	}
	...
	private ItemStack takeStack(IBlockState state) {
		...
		if (i == 1) { return new ItemStack(Items_Teatime.NABE_NAMA_1, 1, 1); }
