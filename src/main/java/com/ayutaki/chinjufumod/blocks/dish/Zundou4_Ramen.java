...
public class Zundou4_Ramen extends BaseStage4_Face {
	...
	public boolean onBlockActivated(World worldIn, BlockPos pos, IBlockState state, EntityPlayer playerIn,
		...
		if (item != Items_Teatime.RAMEN_nama && item != Items_Teatime.Item_SARA) { 
		...
		/** 1=raw-cold, 2=raw-hot, 3＝boiled-cold, 4=boiled-hot **/
			...
			if (i == 3 || i == 4) { 
				if (item == Items_Teatime.RAMEN_nama && k == 4) {
					...
					if (stack.isEmpty()) { playerIn.inventory.addItemStackToInventory(new ItemStack(Items_Teatime.RAMEN, 1, 0)); }
					else if (!playerIn.inventory.addItemStackToInventory(new ItemStack(Items_Teatime.RAMEN, 1, 0))) {
						playerIn.dropItem(new ItemStack(Items_Teatime.RAMEN, 1, 0), false); }
				...
				if (item == Items_Teatime.RAMEN_nama && k == 5) {
					CMEvents.Consume1Item_SnowB(worldIn, pos, playerIn, hand);
					/** Get EXP directly. **/
					playerIn.addExperience(1);
					worldIn.playSound(null, pos, SoundEvents.ENTITY_EXPERIENCE_ORB_PICKUP, SoundCategory.PLAYERS, 0.5F, 0.75F);
					
					if (stack.isEmpty()) { playerIn.inventory.addItemStackToInventory(new ItemStack(Items_Teatime.RAMEN, 1, 1)); }
					else if (!playerIn.inventory.addItemStackToInventory(new ItemStack(Items_Teatime.RAMEN, 1, 1))) {
						playerIn.dropItem(new ItemStack(Items_Teatime.RAMEN, 1, 1), false); }
					
					worldIn.setBlockState(pos, Dish_Blocks.MIZUMILKNABE.getDefaultState()
							.withProperty(H_FACING, state.getValue(H_FACING))
							.withProperty(BaseStage4_Face.STAGE_1_4, Integer.valueOf(i - 2))); }
				
				if (item == Items_Teatime.RAMEN_nama && k == 6) {
					CMEvents.Consume1Item_SnowB(worldIn, pos, playerIn, hand);
					/** Get EXP directly. **/
					playerIn.addExperience(1);
					worldIn.playSound(null, pos, SoundEvents.ENTITY_EXPERIENCE_ORB_PICKUP, SoundCategory.PLAYERS, 0.5F, 0.75F);
					
					if (stack.isEmpty()) { playerIn.inventory.addItemStackToInventory(new ItemStack(Items_Teatime.RAMEN, 1, 2)); }
					else if (!playerIn.inventory.addItemStackToInventory(new ItemStack(Items_Teatime.RAMEN, 1, 2))) {
						playerIn.dropItem(new ItemStack(Items_Teatime.RAMEN, 1, 2), false); }
				...
				if (item == Items_Teatime.Item_SARA) {
					...
					if (stack.isEmpty()) { playerIn.inventory.addItemStackToInventory(new ItemStack(Items_Teatime.RAMEN_nama, 1, 7)); }
					else if (!playerIn.inventory.addItemStackToInventory(new ItemStack(Items_Teatime.RAMEN_nama, 1, 7))) {
						playerIn.dropItem(new ItemStack(Items_Teatime.RAMEN_nama, 1, 7), false); }
