...
public class Frypan_DonNama extends BaseFrypan_2Cook {
	...
	public Frypan_DonNama(Block.Properties properties) {
		super(properties);
	}
	...
	public ActionResultType onBlockActivated(BlockState state, World worldIn, BlockPos pos, PlayerEntity playerIn, Hand hand, BlockRayTraceResult hit) {
		...
		if (i != 1) {
			if (item == Items_Teatime.DONBURI_MESHI) {
				...
				if (stack.isEmpty()) { playerIn.inventory.addItemStackToInventory(takeStack()); }
				else if (!playerIn.inventory.addItemStackToInventory(takeStack())) {
	...
	private ItemStack takeStack() {
		if (this == Dish_Blocks.FPGYUDON_nama) { return new ItemStack(Items_Teatime.DONBURI_GYU, 1); }
		if (this == Dish_Blocks.FPOYAKODON_nama) { return new ItemStack(Items_Teatime.DONBURI_OYAKO, 1); }
		if (this == Dish_Blocks.FPKATSUDON_nama) { return new ItemStack(Items_Teatime.DONBURI_KATSU, 1); }
		return null;
	}
