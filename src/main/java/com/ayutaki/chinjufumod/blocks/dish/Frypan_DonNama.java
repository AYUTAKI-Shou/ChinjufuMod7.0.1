...
public class Frypan_DonNama extends BaseFrypan_2Cook {
	...
	public Frypan_DonNama(BlockBehaviour.Properties properties) {
		super(properties);
	}
	...
	public InteractionResult use(BlockState state, Level worldIn, BlockPos pos, Player playerIn, InteractionHand hand, BlockHitResult hit) {
		...
		if (i != 1) {
			if (item == Items_Teatime.DONBURI_MESHI.get()) {
			...
			if (item != Items_Teatime.DONBURI_MESHI.get()) { CMEvents.textNotHave(worldIn, pos, playerIn); }
		}
	...
	private ItemStack takeStack() {
		if (this == Dish_Blocks.FPGYUDON_nama.get()) { return new ItemStack(Items_Teatime.DONBURI_GYU.get(), 1); }
		if (this == Dish_Blocks.FPOYAKODON_nama.get()) { return new ItemStack(Items_Teatime.DONBURI_OYAKO.get(), 1); }
		if (this == Dish_Blocks.FPKATSUDON_nama.get()) { return new ItemStack(Items_Teatime.DONBURI_KATSU.get(), 1); }
		return null;
	}
	...
	public void appendHoverText(ItemStack stack, @Nullable BlockGetter worldIn, List<Component> tooltip, TooltipFlag tipFlag) {
		...
		tooltip.add(new TranslatableComponent("tips.block_food_frypan_donburi").withStyle(ChatFormatting.GRAY));
	}
}
