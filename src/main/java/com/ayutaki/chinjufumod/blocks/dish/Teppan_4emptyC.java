...
public class Teppan_4emptyC extends BaseTeppan {
	...
	private ItemStack takeStack() {
		if (this == Dish_Blocks.OKONOMIYAKI_click) { return new ItemStack(Items_Teatime.FRYPAN_NAMA_4, 1, 2); }
		if (this == Dish_Blocks.OKONOMIS_click) { return new ItemStack(Items_Teatime.FRYPAN_NAMA_4, 1, 3); }
		if (this == Dish_Blocks.OKONOMIC_click) { return new ItemStack(Items_Teatime.FRYPAN_NAMA_4, 1, 4); }
		return null;
	}
}
