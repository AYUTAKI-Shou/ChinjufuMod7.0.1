...
public class Udon_NikuTsukimi extends BaseStage4_FaceDown {
	...
	public Udon_NikuTsukimi(String name) {
		super(name);
	...
	private ItemStack takeStack() {
		if (this == Dish_Blocks.UDON_NIKU) { return new ItemStack(Items_Teatime.UDON_NIKU, 1, 0); }
		if (this == Dish_Blocks.UDON_TSUKIMI) { return new ItemStack(Items_Teatime.UDON_TSUKIMI, 1, 0); }
		return null;
	}
}
