...
public class Zundou4_Stew extends BaseStage4_Face {
	...
	public boolean onBlockActivated(World worldIn, BlockPos pos, IBlockState state, EntityPlayer playerIn,
		...
		if (item == Items_Teatime.Item_SARA) {
			...
			if (stack.isEmpty()) {
				playerIn.inventory.addItemStackToInventory(new ItemStack(Items_Teatime.STEW, 1, 0)); }
			else if (!playerIn.inventory.addItemStackToInventory(new ItemStack(Items_Teatime.STEW, 1, 0))) {
				playerIn.dropItem(new ItemStack(Items_Teatime.STEW, 1, 0), false); }
