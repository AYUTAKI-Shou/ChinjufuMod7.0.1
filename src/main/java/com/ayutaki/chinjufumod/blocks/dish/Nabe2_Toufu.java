...
public class Nabe2_Toufu extends BaseNabe_2Cook {
	
	public Nabe2_Toufu(BlockBehaviour.Properties properties) {
		super(properties);
	}
	...
	public InteractionResult use(BlockState state, Level worldIn, BlockPos pos, Player playerIn, InteractionHand hand, BlockHitResult hit) {
		...
		if (i != 1) {
			...
			if (stack.isEmpty()) {
				...
				playerIn.getInventory().add(new ItemStack(Items_Teatime.TOUFU.get(), 4));
