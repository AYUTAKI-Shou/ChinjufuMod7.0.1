...
public class Pasta extends BaseFood_Stage4Water {
	...
	private ItemStack takeStack() {
		if (this == Dish_Blocks.PASTACHEESE) { return new ItemStack(Items_Teatime.PASTACHEESE, 1); }
		if (this == Dish_Blocks.PASTAKINOKO) { return new ItemStack(Items_Teatime.PASTAKINOKO, 1); }
		if (this == Dish_Blocks.PASTATOMATO) { return new ItemStack(Items_Teatime.PASTATOMATO, 1); }
		if (this == Dish_Blocks.YAKISOBA) { return new ItemStack(Items_Teatime.YAKISOBA, 1); }
		if (this == Dish_Blocks.YAKISOBASHIO) { return new ItemStack(Items_Teatime.YAKISOBASHIO, 1); }
		return null;
	}
}
