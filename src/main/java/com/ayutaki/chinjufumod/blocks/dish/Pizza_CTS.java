...
public class Pizza_CTS extends Block {
	...
	public boolean onBlockActivated(World worldIn, BlockPos pos, IBlockState state, EntityPlayer playerIn,
		...
		if (stack.isEmpty()) {
			...
			playerIn.inventory.addItemStackToInventory(this.takePizza(state));

			if (i == 3 || i == 7 || i == 11) {
				worldIn.setBlockState(pos, Dish_Blocks.PIZZA.getDefaultState().withProperty(Pizza.STAGE_1_6, Integer.valueOf(5)), 3); }
			if (i != 3 && i != 7 && i != 11) { worldIn.setBlockState(pos, state.withProperty(STAGE_0_11, Integer.valueOf(i + 1)), 3); }
		}
	...
	public int getComparatorInputOverride(IBlockState state, World worldIn, BlockPos pos) {
		return (5 - ((Integer)state.getValue(STAGE_0_11)).intValue()) * 2;
	}
