...
public class Zundou4_Curry extends BaseStage4_Face {
	...
	public boolean onBlockActivated(World worldIn, BlockPos pos, IBlockState state, EntityPlayer playerIn,
		...
		if (item == Items_Teatime.RICE) {
			...
			if (stack.isEmpty()) { playerIn.inventory.addItemStackToInventory(this.getCurryRice()); }
			else if (!playerIn.inventory.addItemStackToInventory(this.getCurryRice())) { playerIn.dropItem(this.getCurryRice(), false); }
	...
	private ItemStack getCurryRice() {
		if (this == Dish_Blocks.CURRYNABE) { return new ItemStack(Items_Teatime.CURRY, 1, 0); }
		if (this == Dish_Blocks.CURRYNABE_C) { return new ItemStack(Items_Teatime.CURRY, 1, 1); }
		if (this == Dish_Blocks.CURRYNABE_T) { return new ItemStack(Items_Teatime.CURRY, 1, 2); }
		return null;
	}
	...
	private ItemStack takeStack() {
		if (this == Dish_Blocks.CURRYNABE) { return new ItemStack(Items_Teatime.CURRYNABE, 1, 0); }
		if (this == Dish_Blocks.CURRYNABE_C) { return new ItemStack(Items_Teatime.CURRYNABE, 1, 1); }
		if (this == Dish_Blocks.CURRYNABE_T) { return new ItemStack(Items_Teatime.CURRYNABE, 1, 2); }
		return null;
	}
