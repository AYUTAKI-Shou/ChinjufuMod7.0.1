...
public class EggBurg extends BaseFood_Stage3Water {
	...
	public EggBurg(BlockBehaviour.Properties properties) {
		super(properties);
	}
		...
		if (i != 3) {
			...
			if (stack.isEmpty()) {
				...
				if (i == 1) {
					...
					playerIn.addEffect(new MobEffectInstance(MobEffects.REGENERATION, 150, 0));
					playerIn.addEffect(new MobEffectInstance(MobEffects.SATURATION, 2, 0)); }
	
				if (i == 2) {
					playerIn.addEffect(new MobEffectInstance(MobEffects.REGENERATION, 210, 0));
					playerIn.addEffect(new MobEffectInstance(MobEffects.SATURATION, 2, 0)); }
	...
	public ItemStack getCloneItemStack(BlockGetter worldIn, BlockPos pos, BlockState state) {
		return new ItemStack(Items_Teatime.EGGBURG.get());
	}
}
