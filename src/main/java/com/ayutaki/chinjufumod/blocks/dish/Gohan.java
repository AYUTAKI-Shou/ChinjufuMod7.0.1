...
public class Gohan extends BaseFood_Stage3Water {
	...
	public Gohan(BlockBehaviour.Properties properties) {
		super(properties);
	}
	...
	public InteractionResult use(BlockState state, Level worldIn, BlockPos pos, Player playerIn, InteractionHand hand, BlockHitResult hit) {
		...
		if (i != 3) {
			...
			if (stack.isEmpty()) {
				...
				if (this != Dish_Blocks.GOHAN.get()) { 
					if (i == 1) { 
						playerIn.addEffect(new MobEffectInstance(MobEffects.DIG_SPEED, 100, 0));
	...
	private ItemStack takeStack() {
		if (this == Dish_Blocks.GOHAN.get()) { return new ItemStack(Items_Teatime.GOHAN.get(), 1); }
		if (this == Dish_Blocks.GOHAN_TAKE.get()) { return new ItemStack(Items_Teatime.GOHAN_TAKE.get(), 1); }
		if (this == Dish_Blocks.GOHAN_KURI.get()) { return new ItemStack(Items_Teatime.GOHAN_KURI.get(), 1); }
		return null;
	}
}
