...
public class Curry_set extends BaseFood_Stage5Water {
	...
	public Curry_set(BlockBehaviour.Properties properties) {
		super(properties);
	}
	...
	public InteractionResult use(BlockState state, Level worldIn, BlockPos pos, Player playerIn, InteractionHand hand, BlockHitResult hit) {
		...
		if (i != 5) {
			...
			if (stack.isEmpty()) {
				...
				if (this == Dish_Blocks.CURRYSET_T.get()) {
					if (i == 1) {
						/** -600 **/
						playerIn.addEffect(new MobEffectInstance(MobEffects.DIG_SPEED, 5700, 0));
					...
					if (i == 4) {
						playerIn.addEffect(new MobEffectInstance(MobEffects.HEAL, 0, 0));
						playerIn.addEffect(new MobEffectInstance(MobEffects.SATURATION, 4, 0));
						playerIn.addEffect(new MobEffectInstance(MobEffects.DAMAGE_RESISTANCE, 3300, 1)); }
				}
	...
	private ItemStack takeStack() {
		if (this == Dish_Blocks.CURRYSET.get()) { return new ItemStack(Items_Teatime.CURRYSET.get(), 1); }
		if (this == Dish_Blocks.CURRYSET_C.get()) { return new ItemStack(Items_Teatime.CURRYSET_C.get(), 1); }
		if (this == Dish_Blocks.CURRYSET_T.get()) { return new ItemStack(Items_Teatime.CURRYSET_T.get(), 1); }
		return null;
	}
}
