...
public class Zundou4_RSoup_nama extends BaseStage4_Face {

	protected static final int COOK_TIME = 1000; /* Long Cook */
	...
	public boolean onBlockActivated(World worldIn, BlockPos pos, IBlockState state, EntityPlayer playerIn,
		...
		if (stack.isEmpty()) {
			if (i == 3 || i == 4) {
				...
				playerIn.inventory.addItemStackToInventory(new ItemStack(Items.DYE, 4, 15));
