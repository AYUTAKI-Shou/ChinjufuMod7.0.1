...
public class Tamagoyaki_set extends BaseFood_Stage5Water {
	...
	public Tamagoyaki_set(BlockBehaviour.Properties properties) {
		super(properties);
	}
	...
	public InteractionResult use(BlockState state, Level worldIn, BlockPos pos, Player playerIn, InteractionHand hand, BlockHitResult hit) {
		...
		if (i != 5) {
			...
			if (stack.isEmpty()) {
				...
				if (this == Dish_Blocks.TAMAGOYAKITEI.get()) { 
					if (i == 1) {
						/** 採掘6000/20=300秒 1秒＝20 満腹は2で肉メモリの1個分 レシピ変更分加算+600 **/
						playerIn.addEffect(new MobEffectInstance(MobEffects.DIG_SPEED, 6600, 0));
					...
					if (i == 4) {
						...
						playerIn.addEffect(new MobEffectInstance(MobEffects.HEAL, 0, 0));
						playerIn.addEffect(new MobEffectInstance(MobEffects.SATURATION, 4, 0));
						playerIn.addEffect(new MobEffectInstance(MobEffects.DAMAGE_RESISTANCE, 4200, 1)); }
				}

				if (this != Dish_Blocks.TAMAGOYAKITEI.get()) { 
					if (i == 1) {
						/** +100 **/
						playerIn.addEffect(new MobEffectInstance(MobEffects.DIG_SPEED, 6700, 0));
						playerIn.addEffect(new MobEffectInstance(MobEffects.SATURATION, 4, 0)); }
					...
					if (i == 3) {
						...
						playerIn.addEffect(new MobEffectInstance(MobEffects.HEAL, 0, 0));
						playerIn.addEffect(new MobEffectInstance(MobEffects.SATURATION, 4, 0));
						playerIn.addEffect(new MobEffectInstance(MobEffects.REGENERATION, 4300, 0)); }
		
					if (i == 4) {
						/** +100 **/
						playerIn.addEffect(new MobEffectInstance(MobEffects.HEAL, 0, 0));
						playerIn.addEffect(new MobEffectInstance(MobEffects.SATURATION, 4, 0));
						playerIn.addEffect(new MobEffectInstance(MobEffects.DAMAGE_RESISTANCE, 4300, 1)); }
				}
	...
	private ItemStack takeStack() {
		if (this == Dish_Blocks.TAMAGOYAKITEI.get()) { return new ItemStack(Items_Teatime.TAMAGOYAKITEI.get(), 1); }
		if (this == Dish_Blocks.TAMAGOYAKITEI_TAKE.get()) { return new ItemStack(Items_Teatime.TAMAGOYAKITEI_TAKE.get(), 1); }
		if (this == Dish_Blocks.TAMAGOYAKITEI_KURI.get()) { return new ItemStack(Items_Teatime.TAMAGOYAKITEI_KURI.get(), 1); }
		return null;
	}
}
