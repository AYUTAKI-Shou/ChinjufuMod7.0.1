...
public class Frypan_TakePlate extends BaseFrypan_2Cook {
	...
	public Frypan_TakePlate(AbstractBlock.Properties properties) {
		super(properties);
	}
	...
	private ItemStack takeStack() {
		if (this == Dish_Blocks.FPEGGBURG_nama) { return new ItemStack(Items_Teatime.EGGBURG, 1); }
		if (this == Dish_Blocks.FPTAMAGO_nama) { return new ItemStack(Items_Teatime.TAMAGOYAKI, 1); }
		return null;
	}
