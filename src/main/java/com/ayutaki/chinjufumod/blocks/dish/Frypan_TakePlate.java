...
public class Frypan_TakePlate extends BaseFrypan_2Cook {
	...
	public Frypan_TakePlate(BlockBehaviour.Properties properties) {
		super(properties);
	}
	...
	private ItemStack takeStack() {
		if (this == Dish_Blocks.FPEGGBURG_nama.get()) { return new ItemStack(Items_Teatime.EGGBURG.get(), 1); }
		if (this == Dish_Blocks.FPTAMAGO_nama.get()) { return new ItemStack(Items_Teatime.TAMAGOYAKI.get(), 1); }
		return null;
	}
