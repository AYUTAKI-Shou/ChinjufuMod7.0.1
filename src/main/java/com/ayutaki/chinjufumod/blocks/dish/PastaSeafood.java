...
public class PastaSeafood extends BaseStage4_FaceDown {
	...
	public List<ItemStack> getDrops(IBlockAccess worldIn, BlockPos pos, IBlockState state, int fortune) {
		...
		int i = ((Integer)state.getValue(STAGE_1_4)).intValue();
		if (i == 1) { stack.add(new ItemStack(Items_Teatime.PASTASEAFOOD, 1, 0)); }
		if (i != 1) { 
			stack.add(new ItemStack(Items_Teatime.Item_SARA, 1, 0));
			stack.add(new ItemStack(Items_Teatime.HAMAGURI_KARA, 3, 0)); }
		return stack;
	}
