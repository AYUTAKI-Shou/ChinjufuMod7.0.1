...
public class BaseGate_Part2 extends BaseGate {
	
	public BaseGate_Part2(Material material, String name) {
		super(material, name);
	}
	...
	private Block takeBlock1() {
		...
		if (this == Gate_Blocks.GATE_IRONGRILL2) { return Gate_Blocks.GATE_IRONGRILL; }
		return null;
	}
